...
/**
 * This is the model class for table "online_register_settings".
 *
 * The followings are the available columns in table 'online_register_settings':
 * @property integer $id
 * @property string $config_key
 * @property string $config_value
 */
class OnlineRegisterSettings extends CActiveRecord
{
	
	/**
	 * Returns the static model of the specified AR class.
	 * @return OnlineRegisterSettings the static model class
	 */
	...
	{
		return 'online_register_settings';
	}

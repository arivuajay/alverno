...
class FinanceFeeCategories extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('batch_id, academic_yr_id, is_deleted, is_master', 'numerical', 'integerOnly'=>true),
			...
			array('id, name, description, batch_id, academic_yr_id, is_deleted, is_master, created_at, updated_at', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('academic_yr_id',Yii::app()->user->year);

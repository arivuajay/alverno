...
/**
 * This is the model class for table "complaint_categories".
 *
 * The followings are the available columns in table 'complaint_categories':
 * @property integer $id

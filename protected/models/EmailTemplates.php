...
class EmailTemplates extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('template, created_by, created_at, subject', 'required'),
			array('created_by', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, template, created_by, created_at, subject, name, ', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'created_by' => Yii::t("app",'Edited By'),
			'created_at' => Yii::t("app",'Edited At'),

			...
			function t($message, $category = 'cms', $params = array(), $source = null, $language = null) 
{
    return $message;
			...
			array('label'=>''.'<h1>'.Yii::t('app','Manage Room').'</h1>'),  
					array('label'=>''.Yii::t('app','List Room Details').'<span>'.Yii::t('app','All Room Details').'</span>', 'url'=>array('/hostel/Room/manage') ,'linkOptions'=>array('class'=>'lbook_ico'),
                                   'active'=> (Yii::app()->controller->id=='room' and Yii::app()->controller->action->id=='manage')
					    ),
						array('label'=>''.Yii::t('app','Search Room').'<span>'.Yii::t('app','Search All Rooms').'</span>', 'url'=>array('/hostel/Room/roomsearch') ,'linkOptions'=>array('class'=>'sroom_ico'),
                                   'active'=> (Yii::app()->controller->id=='room' and Yii::app()->controller->action->id=='roomsearch')
					    ),        
						
						array('label'=>''.Yii::t('app','Hostel Details').'<span>'.Yii::t('app','Add New Hostel Details').'</span>', 'url'=>array('/hostel/Hosteldetails/manage') ,'linkOptions'=>array('class'=>'evntlist_ico'),
						...
						array('label'=>''.Yii::t('app','Add Room Details').'<span>'.Yii::t('app','Add New Room Details').'</span>', 'url'=>array('/hostel/Floor/create') ,'linkOptions'=>array('class'=>'abook_ico'),
                                   'active'=> (Yii::app()->controller->id=='floor' and Yii::app()->controller->action->id=='create')
					    ),      
						array('label'=>''.Yii::t('app','Add Mess Details').'<span>'.Yii::t('app','Add New Mess Details').'</span>', 'url'=>array('/hostel/foodInfo/manage') ,'linkOptions'=>array('class'=>'sl_ico'),
					...
					array('label'=>''.Yii::t('app','Allot Room').'<span>'.Yii::t('app','Allot New Room').'</span>', 'url'=>array('/hostel/registration/create') ,'linkOptions'=>array('class'=>'aroom_ico'),
						...
						array('label'=>''.Yii::t('app','Change Room').'<span>'.Yii::t('app','Manage Rooms').'</span>', 'url'=>array('/hostel/Room/roomchange') ,'linkOptions'=>array('class'=>'c_room_ico'),
                                   'active'=> (Yii::app()->controller->id=='room' and Yii::app()->controller->action->id=='roomchange' )
					    ),  
						array('label'=>''.Yii::t('app','Vacate').'<span>'.Yii::t('app','Manage Rooms').'</span>', 'url'=>array('/hostel/Vacate/roomvacate') ,'linkOptions'=>array('class'=>'vroom_ico'),
						...
						array('label'=>''.Yii::t('app','View Student Details').'<span>'.Yii::t('app','All Student Details').'</span>', 'url'=>array('/hostel/MessManage/manage') ,'linkOptions'=>array('class'=>'vsd_ico'),
						...
						array('label'=>''.Yii::t('app','Mess Manage').'<span>'.Yii::t('app','Manage Mess Details').'</span>', 'url'=>array('/hostel/MessManage/messinfo') ,'linkOptions'=>array('class'=>'m_manage_ico'),
						...
						array('label'=>''.Yii::t('app','View Mess Dues').'<span>'.Yii::t('app','Manage Mess Dues').'</span>', 'url'=>array('/hostel/settings/settings') ,'linkOptions'=>array('class'=>'vmd_ico'),
                                   'active'=> (Yii::app()->controller->id=='settings' and Yii::app()->controller->action->id=='settings')
					    ), 
						array('label'=>''.'<h1>'.Yii::t('app','Notifications').'</h1>'),
						array('label'=>''.Yii::t('app','Notifications').'('.count($cnt).')'.'<span>'.Yii::t('app','View Notifications').'</span>', 'url'=>array('/hostel/settings/notifications') ,'linkOptions'=>array('class'=>'notify_ico'),

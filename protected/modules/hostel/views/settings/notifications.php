			...
			if($request!=NULL)
			{
				...
				foreach($request as $request_1)
				{
					...
					{						
						...
						echo '&nbsp;<strong>'.$name.'&nbsp;has requested for changing room to'.' '.$room->room_no.'&nbsp;</strong>[&nbsp;'.CHtml::link(Yii::t('app','Allot'),array('/hostel/allotment/create','studentid'=>$request_1->student_id,'allotid'=>$request_1->allot_id,'floor_id'=>$floor->id)).'&nbsp;]<br></td>' ;

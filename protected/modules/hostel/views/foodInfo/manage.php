        ...
        <td valign="top">
            <div class="cont_right">
                ...
                <div class="edit_bttns" style="top:20px; right:20px;">
                    <ul>
                    <li> <?php echo CHtml::link('<span>'.Yii::t('app','Enter Mess Details').'</span>', array('/hostel/foodInfo/create'),array('class'=>'addbttn last ')); ?></li>
                    </ul>
                        ...
                        if($hst!=NULL)
                        {
							...
							<tr>
                                ...
                                <td align="center">
                                    ...
                                    {
                                        echo CHtml::link(Yii::t('app','Delete'),array('/hostel/foodInfo/deleteall','id'=>$hostel->id),array('confirm'=>Yii::t('app','Are you sure?')));
                                    }
                                    ?>

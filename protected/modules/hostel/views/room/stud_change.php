        ...
        <div class="people-item">
          <div class="profile_details">
            <div id="studentname" style="display:block;">
              ...
              <div class="form-group">
              <div class="col-sm-2"><?php echo '<strong>'.CHtml::label(Yii::t('app','Select Floor'),array('class'=>'control-label'),'').'</strong>';?> </div>
              <div class="col-sm-3">  
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3"> <?php echo CHtml::submitButton( Yii::t('app','Search'),array('name'=>'search','class'=>'btn btn-primary')); ?></div>
              </div>
            </div>

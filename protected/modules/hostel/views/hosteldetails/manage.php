        ...
        <td valign="top">
            <div class="cont_right">
                ...
                <div class="edit_bttns" style="top:20px; right:20px;">
                    <ul>
                    	<li> <?php echo CHtml::link('<span>'.Yii::t('app','Enter Hostel Details').'</span>', array('/hostel/Hosteldetails/create'),array('class'=>'addbttn last ')); ?></li>
                    </ul>
						...
						?>
                            <tr>
								...
								?>
                                    ...
                                    {
                                        echo CHtml::link(Yii::t('app','Delete'),array('/hostel/Hosteldetails/deleteall','id'=>$hostel->id),array('confirm'=>Yii::t('app','Are you sure?')));
                                    }
                                    ?>

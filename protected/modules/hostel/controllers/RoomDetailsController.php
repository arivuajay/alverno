...
class RoomDetailsController extends RController
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('RoomDetails');
	...
	{
		$model=new RoomDetails('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['RoomDetails']))
			$model->attributes=$_GET['RoomDetails'];
	...
	{
		$model=RoomDetails::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='room-details-form')
		{

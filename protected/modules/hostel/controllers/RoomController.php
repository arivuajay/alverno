...
class RoomController extends RController
{
	...
	public function actionUpdate($id)
	{
		...
		/*$data=Allotment::model()->findAllByAttributes(array('id'=>$id));
		echo $data->room_no;exit;
		$room=Room::model()->findByAttributes(array('id'=>$date->id));
	...
	public function actionChange()
	{
		...
		if(isset($_POST['search']))
		{
				...
				if((isset($_POST['floor']) and $_POST['floor']!=NULL) and (isset($_POST['hostel']) and $_POST['hostel']!=NULL))
				{
					...
					$floor = Floor::model()->findByAttributes(array('floor_no'=>$_POST['floor'],'hostel_id'=>$_POST['hostel']));

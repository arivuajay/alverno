...
<?php 
	...
	{
	?>
		<span style="color:#F00; font-weight:bold">*<?php Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").' '.Yii::t('app','Weekdays not set. System default weekdays will be selected.'); ?></span>
		<?php	

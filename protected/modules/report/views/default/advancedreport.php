                    ...
                    <div class="formConInner">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="s_search">
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td><?php echo CHtml::activeDropDownList($model,'gender',array('M' => Yii::t('app','Male'), 'F' => Yii::t('app','Female')),array('prompt'=>Yii::t('app','All'))); ?></td>
                            </tr>
                            <tr>
                            	<td colspan="4">&nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td><?php echo CHtml::activeDropDownList($model,'blood_group',
                                        ...
                                        array('prompt' => Yii::t('app','Select'))); ?></td>
                            </tr>
                            <tr>
                            	<td colspan="4">&nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                <input type="checkbox" id="checkbox-1-1" class="regular-checkbox"  name="guard"  /><strong><?php echo Yii::t('app','Include guardian details');?></strong></td>
                                <td>&nbsp;</td>
                                <td></td>
                            </tr>
                            <tr>

...
<div class="temp_div" style="padding: 0 5px 19px 0;">
    ...
    <?php echo CHtml::link(Yii::t('app','Send Reminder'),array('/report/notification/mail','student_id'=>$_GET['student_id']),array('class'=>'formbut','style'=>'padding:7px 13px ;margin-left: 37px;'));?>
   </div>
<?php
				if(count($data)==0)
				{

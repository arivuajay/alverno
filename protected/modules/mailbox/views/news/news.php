...
$this->breadcrumbs=array(
  ...
  <tr>
    ...
    <div class="edit_bttns" style="top:20px; right:20px;">
        <ul>
        	<li> <?php echo CHtml::link('<span>'.Yii::t('app','Create News').'</span>', array('/news/create'),array('class'=>'addbttn last ')); ?></li>
            <li> <?php echo CHtml::link('<span>'.Yii::t('app','Publish News').'</span>', array('/news/admin'),array('class'=>'addbttn last ')); ?></li>
        </ul>
    </div>

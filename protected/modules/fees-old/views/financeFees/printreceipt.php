...
<?php
	...
	$list_1  = FinanceFees::model()->findByAttributes(array('fee_collection_id'=>$_REQUEST['collection'],'student_id'=>$_REQUEST['id'],'is_paid'=>1));
...
<table width="700" border="1" bgcolor="#f9feff">
          ...
          <tr>
            <td width="150"><?php $logo=Logo::model()->findAll();?>
              <?php
                ...
                ?></td>
            <td  width="500"valign="middle"><h1 style="font-size:20px; text-align:left;">
  ...
  <tr>
    <td width="650" style="border-bottom:#ccc 1px solid; padding:10px 20px;"><table  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="550" style="padding:10px 0px;"><?php echo Yii::t('app','Reciept No'); ?> : <?php echo $receipt_no;?></td>
          <td><?php echo Yii::t('app','Date'); ?> :
            <?php 
        ...
        <tr>
          <td style="padding:5px 0px;"><?php echo Yii::t('app','Name'); ?> :
            <?php  echo $student->first_name.' '.$student->last_name; ?></td>
          <td style="padding:5px 0px;"><?php echo Yii::t('app','Admission Number'); ?> : <?php echo $student->admission_no; ?></td>
        </tr>
        <tr>
          <td style="padding:5px 0px;"><?php echo Yii::t('app','Course'); ?>  : <?php echo $batch->course123->course_name; ?></td>
          <td style="padding:5px 0px;"><?php echo Yii::t('app','Batch'); ?> : <?php echo $batch->name; ?></td>
        </tr>
        <tr>
          <td style=" padding:10px 0px;"><?php echo Yii::t('app','Address'); ?> : <?php echo $student->address_line1.' , '.$student->city.' , '.$student->state;?></td>
        </tr>
        <tr>
          <td><?php echo Yii::t('app','Fee Category'); ?> : <?php echo $category->name; ?></td>
          <td></td>
        </tr>
      </table></td>
  </tr>
  <tr>
    <td width="650" style="padding:10px 0px;"><div style="padding:20px 20px;" class="tableinnerlist">
        <table width="760" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td style="border-top:#cad4dc 1px solid; border-left:#cad4dc 1px solid; background:#e4eaed;" width="190"><?php echo Yii::t('app','Sl no.'); ?></td>
            <td style="border-top:#cad4dc 1px solid; border-left:#cad4dc 1px solid; background:#e4eaed;" width="190"><?php echo Yii::t('app','Particulars'); ?></td>
            <td style="border-top:#cad4dc 1px solid; border-left:#cad4dc 1px solid; background:#e4eaed;" width="190"><?php echo Yii::t('app','Amount'); ?></td>
          </tr>
          <?php /*?><?php 
            $i = 1;
          ...
          <tr>
            ...
            <td style="color:#333333; font-size:16px; text-align:right; background:#e4eaed;"><?php echo Yii::t('app','Grand Total'); ?></td>
            <td style="color:#333333; font-size:16px; background:#e4eaed;"><?php echo number_format($amount,2).' '.$currency->config_value;?></td>
          </tr>
          <tr>
          	<td style="border-left:#cad4dc 1px solid;">&nbsp;</td>
            <td><?php echo Yii::t('app','Fees Paid');?></td>
  ...
  <tr>
    <td><div>
        <table width="750" border="0" cellspacing="0" cellpadding="0" style="padding:30px 0px;">
          <tr>
            <td width="20"></td>
            <td width="200" align="left"><?php echo Yii::t('app','Month:').date('F',strtotime($collection->start_date));?></td>
            <td width="200">&nbsp;</td>

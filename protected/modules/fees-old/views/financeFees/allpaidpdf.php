...
<?php
  ...
  if(isset($_REQUEST['collection']) && isset($_REQUEST['batch']))
  {
    ...
    <br />
    <!-- End Header -->
   <div align="center" style="text-align:center; display:block;"><?php echo Yii::t('app','LIST OF STUDENTS WITH PAID AND UNPAID FEES'); ?></div><br />
   ...
   <table style="font-size:13px; background:#DCE6F1; padding:10px 10px;border:#C5CED9 1px solid;">
            ...
            <tr>
                ...
                <td>:</td>
                <td width="245"><?php echo $category->name; ?></td>
            </tr>
            <?php 
...
<table width="100%" cellspacing="0" class="unpaid_table">
    <tr style="background:#DCE6F1; text-align:center; line-height:10px;">
        ...
        <td style="width:210px; padding-top:10px;"><?php echo Yii::t('app','Name of the student');?></td>

 ...
 * FeeCollectionParticularsController *
...
class FeeCollectionParticularsController extends RController
{
	/**
...
public function   init() {
  ...
  private function registerAssets(){
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='fee-collection-particulars-form')
		{
        ...
        $this->renderPartial('view',array('model'=>$model),false, true);
             ...
             if(isset($_POST['update_id']))$model= $this->loadModel($_POST['update_id']);else $model=new feeCollectionParticulars;
		...
		$model=new feeCollectionParticulars('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['feeCollectionParticulars']))
			$model->attributes=$_GET['feeCollectionParticulars'];
  ...
  public function actionAjax_Create(){
 	...
 	public function getCreated_atf(){

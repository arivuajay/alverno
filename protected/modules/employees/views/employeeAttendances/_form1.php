...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
        ...
        <?php 
			...
			{
			echo $form->dropDownList($model,'employee_leave_type_id',CHtml::listData(EmployeeLeaveTypes::model()->findAll("status=:x",array(':x'=>1)), 'id', 'name'),array('empty'=>Yii::t('app','Select Type'))); 
			}
			else
			{

		...
		if(in_array(Yii::app()->controller->action->id,array('create')) and in_array(Yii::app()->controller->id,array('employees')))
                {
                    ...
                    {
                        echo '<li><h2 class="cur">'.CHtml::link(Yii::t('app','Teacher Details'),array('/employees/employees/create','id'=>$_REQUEST['id'])).'</h2></li>';
                    } 
                    else
                    {
                ...
                if(in_array(Yii::app()->controller->action->id,array('create2')) and in_array(Yii::app()->controller->id,array('employees')))
                {
                    if(isset($_REQUEST['id']))
                    {
                        ...
                        echo '<li><h2 class="cur">'.CHtml::link(Yii::t('app','Teacher Contact Details'),array('/employees/employees/create2','id'=>$_REQUEST['id'])).'</h2></li>';

...
<div class="empimgbx" style="height:128px;">
   ...
   $employee=Employees::model()->findByAttributes(array('id'=>$_REQUEST['id']));
	 ...
	 {
		echo '<img  src="images/s_prof_m_image.png" alt='.$employee->first_name.' width="170" height="140" />'; 
	 }
	 elseif($employee->gender == 'F')
	 {
		echo '<img  src="images/s_prof_fe_image.png" alt='.$employee->first_name.' width="170" height="140" />';  
	 }

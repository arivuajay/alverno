...
<h1><?php echo Yii::t('app','Manage Teachers');?></h1>
    ...
    <li><a href="#" class="load_filter" onClick="hide('load')"><span><?php echo Yii::t('app','Load Filter');?></span></a> 
...
<div id="admissionnumber" style="display:none; width:231px; padding-top:0px; height:33px" class="drop">
<div class="droparrow" style="left:10px;"></div>
...
<div id="batch" style="display:none; width:240px; padding-top:0px; height:33px" class="drop">
<div class="droparrow" style="left:10px;"></div>
<?php 
...
<div id="cat" style="display:none; width:239px; padding-top:0px; height:33px" class="drop">
<div class="droparrow" style="left:10px;"></div>
<?php 
...
<div id="pos" style="display:none; width:238px; padding-top:0px; height:33px" class="drop">
<div class="droparrow" style="left:10px;"></div>
<?php 
...
<div id="grd" style="display:none; width:239px; padding-top:0px; height:33px; left:-140px" class="drop">
...
<div id="gender" style="display:none; width:242px; padding-top:0px; height:33px; left:-140px" class="drop">
<div class="droparrow" style="left:150px;"></div>
<?php 
...
<div id="marital" style="display:none; width:250px; padding-top:0px; height:33px; left:-140px" class="drop">
...
<div id="nationality" style="display:none; width:240px; left:-180px; height:33px; padding-top:0px;" class="drop">
...
<div id="dob" style="display:none; width:390px; left:-210px; height:33px; padding-top:0px;" class="drop">
...
<div id="joining" style="display:none; width:390px; left:-190px;  height:33px; padding-top:0px;" class="drop">
<div class="droparrow" style=" left:220px"></div>
<?php echo CHtml::activeDropDownList($model,'joinrange',array('1' => Yii::t('app','before'), '2' => Yii::t('app','in'), '3' => Yii::t('app','after')),array('prompt'=>Yii::t('app','Option'))); ?>
<?php 
				$this->widget('zii.widgets.jui.CJuiDatePicker', array(
...
echo CHtml::activeDropDownList($model,'status',array('1' => 'Present', '0' => 'Former'),array('selected'=>'selected','prompt'=>Yii::t('app','All'))); 
 ...
 <input type="submit" value="Apply" />
        ...
        <div class="contrht_bttns" style="top:198px; right:-59px; z-index:1000">
        <ul>
           <li>
            <button type="submit" class="ea_pdf pdf_but"  name= "print" formtarget="_blank">
...
<?php $this->endWidget(); ?>
    ...
    { 
	    $j++; ?>
    <li><?php echo Yii::t('app','Admission number');?> : <?php echo $_REQUEST['employeenumber']?><a href="<?php echo Yii::app()->request->getUrl().'&employeenumber='?>"></a></li>
    <?php } ?>
	...
	{
	    $j++; ?>
    <li><?php echo Yii::t('app','Country');?> : <?php echo Countries::model()->findByAttributes(array('id'=>$_REQUEST['Employees']['nationality_id']))->name?><a href="<?php echo Yii::app()->request->getUrl().'&Employees[nationality_id]='?>"></a></li>
    <?php } ?>
...
<div class="clear"></div>
    ...
    <ul>
    <li><?php echo CHtml::link(Yii::t('app','Add Teacher'), array('create'),array('class'=>'addbttn last')); ?></li>
    </ul>
    </div>
 ...
 <tr class="<?php echo $cls;?>" id="<?php echo $i;?>">
	...
	if((($year == $current_academic_yr->config_value)) or ($year != $current_academic_yr->config_value and $is_delete->settings_value!=0))
	{
		...
		echo CHtml::ajaxLink(Yii::t('app','Delete'), array('deletes','id'=>$list_1->id), array('success'=>'rowdelete('.$i.')'),array('confirm'=>Yii::t('app','Are you sure ? Do you want to delete this teacher ?')));
	}
...
{  
	...
	{		
		...
		window.location='<?php echo Yii::app()->getBaseUrl(true)?>/index.php?r=employees/employees/delete_all&id='+favorite;
		return true;
		}
		else
		{

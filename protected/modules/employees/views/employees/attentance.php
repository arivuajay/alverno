...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
   ...
   <h1 style="margin-top:.67em;">
					<?php echo Yii::t('app','Teacher Profile :');?> <?php echo ucfirst($model->first_name).' '.ucfirst($model->middle_name).' '.ucfirst($model->last_name); ?><br />
                </h1>
                <div class="edit_bttns last">
                    <ul>
                        ...
                        <li>
                        	<?php echo CHtml::link('<span>'.Yii::t('app','Teacher').'</span>', array('employees/manage'),array('class'=>'edit last'));?>
                        </li>
                    </ul>
...
<?php
  ...
  if(isset($_REQUEST['id']))
  {
	...
	<div align="center" class="atnd_tnav" style="top:10px; left:29%;">
	<?php 

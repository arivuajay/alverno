...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	echo '<div class="formCon"><div class="formConInner"><div style="float:left; width:380px;"><span style="font-size:14px; font-weight:bold; color:#666;">'.Yii::t('app','Course').'</span>&nbsp;&nbsp;&nbsp;&nbsp;';
	echo CHtml::dropDownList('id','',$data,array('prompt'=>Yii::t('app','Select'),'onchange'=>'course()','id'=>'cou','options'=>array($sel=>array('selected'=>true)))); 
	echo '</div>';
	echo '<div style="float:left; width:300px;"><span style="font-size:14px; font-weight:bold; color:#666;">'.Yii::t('app','Subject').'</span>&nbsp;&nbsp;'; ?>
...
if(isset($_REQUEST['sub']))
{
	...
	if(count($emp_sub)==0)
	{
		echo '<br> <br><i>'.Yii::t('app','No Teacher assigned yet.').'</i><br> <br>';
	}
	else
	{
	?>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                ?>
                    <tr>
						...
						?>
                        	<td>
							<?php echo CHtml::link(Yii::t('app','Remove'), array('deleterow', 'id'=>$emp_sub_1->id,'sub'=>$_REQUEST['sub'],'cou'=>$_REQUEST['cou'],'dept'=>$_REQUEST['dept']), array('confirm' => Yii::t('app','Are you sure?'),'onclick'=>"show()")); ?>
                            </td>
						<?php
						}
						?>
	...
	{
		echo '<br><span style="font-size:14px; font-weight:bold; color:#666;">'.Yii::t('app','Departments').'</span>&nbsp;&nbsp;';
				...
				<div class="tableinnerlist">
					<table width="100%" cellpadding="0" cellspacing="0">
						...
						foreach($employee as $employee_1)
						{
							...
							echo '<td>'.CHtml::link(Yii::t('app','Assign'), array('employeesSubjects/Assign', 'emp_id'=>$employee_1['id'],'sub'=>$_REQUEST['sub'],'cou'=>$_REQUEST['cou'],'dept'=>$_REQUEST['dept']), array('confirm' => Yii::t('app','Are you sure?'))).'</td>'; 	
							echo '</tr>';
						}
						?>
					</table>
...
<hr/>
    ...
    echo '<div class="formCon"><div class="formConInner"><div style="float:left; width:380px;"><span style="font-size:14px; font-weight:bold; color:#666;">'.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").'</span>&nbsp;&nbsp;&nbsp;&nbsp;';
...
if(isset($_REQUEST['elect']))
{
	...
	{
		echo '<br> <br><li>'.Yii::t('app','No Teacher assigned yet').'</li><br> <br>';
	}
	else
	{
	?>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                ?>
                    <tr>
                        ...
                        ?>
                        <td>
							<?php echo CHtml::link(Yii::t('app','Remove'), array('employeeElectiveSubjects/deleterow', 'id'=>$emp_electsub_1->id,'elect'=>$_REQUEST['elect'],'bid'=>$_REQUEST['bid'],'dep'=>$_REQUEST['dep']), array('confirm' => Yii::t('app','Are you sure?'),'onclick'=>"show()")); ?>
						</td>
                        <?php
						}
						?>
			...
			?>
				...
				<div class="tableinnerlist">
					<table width="100%" cellpadding="0" cellspacing="0">
						...
						echo '<tr>';
							echo '<td>'.$employee_1['first_name'].'  '.$employee_1['middle_name'].'  '.$employee_1['last_name'].'</td>';
							echo '<td>'.CHtml::link(Yii::t('app','Assign'), array('employeeElectiveSubjects/Assign', 'emp_id'=>$employee_1['id'],'elect'=>$_REQUEST['elect'],'bid'=>$_REQUEST['bid'],'dep'=>$_REQUEST['dep']), array('confirm' => Yii::t('app','Are you sure?'))).'</td>'; 	
						echo '</tr>';
						}
						?>
					</table>

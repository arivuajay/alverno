		   ...
		   $model=Achievements::model()->findByAttributes(array('id'=>$_POST['Achievements']['did']));
			...
			{ 
				...
				if($model->save())
				{
					if($_FILES['Achievements']['name']['file']!=NULL)
					{
						$old_destination_file = 'uploadedfiles/employee_achievement_document/'.$model->user_id.'/'.$old_model['file'];	
				...
				else
				{
					...
					$this->redirect(array('update','id'=>$_POST['Achievements']['eid'],'document_id'=>$model->id));
				}

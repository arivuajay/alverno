...
<div id="events-type_form_con" class="client-val-form">
    ...
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header"><?php echo Yii::t('app','Update Event Type');?> <?php  echo
        $model->id;  ?>  </h3>
    <?php   endif;  ?>
    <?php      $val_error_msg = Yii::t('app','Error.EventsType was not saved.');
    $val_success_message = ($model->isNewRecord) ?
            Yii::t('app','Event Type was created successfuly.') :
            Yii::t('app','Event Type  was updated successfuly.');
  ?>

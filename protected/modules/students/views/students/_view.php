<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('admission_no')); ?>:</b>
	<?php echo CHtml::encode($data->admission_no); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('class_roll_no')); ?>:</b>
	<?php echo CHtml::encode($data->class_roll_no); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('student_category_id')); ?>:</b>
	<?php echo CHtml::encode($data->student_category_id); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('immediate_contact_id')); ?>:</b>
	<?php echo CHtml::encode($data->immediate_contact_id); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('is_sms_enabled')); ?>:</b>
	<?php echo CHtml::encode($data->is_sms_enabled); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('has_paid_fees')); ?>:</b>
	<?php echo CHtml::encode($data->has_paid_fees); ?>
	<br />

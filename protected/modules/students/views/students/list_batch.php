    ...
    <div class="formConInner" style="width:50%; height:auto;">
        ...
        <div class="row">
                <?php
                    ...
                    $criteria->params = array(':id'=>4);
                    echo $form->dropDownList($model,'result_status',  CHtml::listData(PromoteOptions::model()->findAll($criteria),'option_value','option_name'),array('empty'=>Yii::t('app','Select'))); 
                ?>

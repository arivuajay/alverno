...
?>
                        ...
                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%">
                                                    	<ul class="tt-wrapper">
															...
															?>
															<li>
																<?php echo CHtml::link('<span>'.Yii::t('app','Delete').'</span>', array('studentDocument/deletes','id'=>$document->id,'student_id'=>$document->student_id),array('class'=>'tt-delete','confirm'=>Yii::t('app','Are you sure you want to delete this?'))); ?>
															</li>
                                                            <?php
															}
															?>
                         ...
                         <div></div>
                        <div>
                       <?php echo CHtml::link('<span>'.Yii::t('app','Notify Parent').'</span>', array('studentDocument/notify','id'=>$_REQUEST['id']),array('class'=>'formbut','confirm'=>'Notify parent?'));?></div><br />
<br />

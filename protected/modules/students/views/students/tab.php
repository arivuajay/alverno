...
<div class="emp_tab_nav">
    <ul style="width:730px;">
        ...
        <?php     
	          ...
	          {
		      echo CHtml::link(Yii::t('app','Profile'), array('/students/students/view', 'id'=>$_REQUEST['id']),array('class'=>'active'));
			  }
			  else
			  {
	          echo CHtml::link(Yii::t('app','Profile'), array('/students/students/view', 'id'=>$_REQUEST['id']));
			  }
	    ?>
		</li>
        ...
        <?php     
	          ...
	          {
		      echo CHtml::link(Yii::t('app','Assessments'), array('/students/students/assesments', 'id'=>$_REQUEST['id']),array('class'=>'active'));
			  }
			  else
			  {
	          echo CHtml::link(Yii::t('app','Assessments'), array('/students/students/assesments', 'id'=>$_REQUEST['id']));
			  }
	    ?>
		</li>
		...
		if($model->config_value == 1){     
	          ...
	          {
		      echo CHtml::link(Yii::t('app','Attendance'), array('/students/students/attentance', 'id'=>$_REQUEST['id']),array('class'=>'active'));
			  }
			  else
			  {
	          echo CHtml::link(Yii::t('app','Attendance'), array('/students/students/attentance', 'id'=>$_REQUEST['id']));
			  }
		}else{
			  if(Yii::app()->controller->id=='subjectAttendance')
			  {
			  echo CHtml::link(Yii::t('app','Attendance'), array('/attendance/subjectAttendance/individual', 'id'=>$_REQUEST['id']),array('class'=>'active'));
			  }
			  else
			  {
			  echo CHtml::link(Yii::t('app','Attendance'), array('/attendance/subjectAttendance/individual', 'id'=>$_REQUEST['id']));
			  }
		}
	    ?>
		</li>
        ...
        <?php     
	          ...
	          {
		      echo CHtml::link(Yii::t('app','Fees'), array('/students/students/fees', 'id'=>$_REQUEST['id']),array('class'=>'active'));
			  }
			  else
			  {
	          echo CHtml::link(Yii::t('app','Fees'), array('/students/students/fees', 'id'=>$_REQUEST['id']));
			  }
	    ?>
		</li><?php */?>
        ...
        <?php     
	          if(Yii::app()->controller->action->id=='document' or Yii::app()->controller->id=='studentDocument')
	          {
				...
				echo CHtml::link(Yii::t('app','Documents'), array('/students/students/document', 'id'=>$_REQUEST['id']),array('class'=>'active'));
				  
		      
			  }
			  else
			  {
	          echo CHtml::link(Yii::t('app','Documents'), array('/students/students/document', 'id'=>$_REQUEST['id']));
			  }
	    ?>
		</li>
        <li> 

                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%">
                                                        ...
                                                        ?>
															...
															<li>
																<?php echo CHtml::link('<span>'.Yii::t('app','Delete').'</span>', array('achievements/deletes','id'=>$document->id,'student_id'=>$_REQUEST['id']),array('class'=>'tt-delete','confirm'=>Yii::t('app','Are you sure you want to delete this?'))); ?>
															</li>
                                                           <li>
                                                             	<?php	

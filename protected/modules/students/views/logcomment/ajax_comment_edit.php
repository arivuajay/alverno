                                	...
                                	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     <tr>
                                      ...
                                      <tr>
                                        ...
                                        <tr><td>&nbsp;</td></tr>
                                        <tr><td>
                                        			<?php echo $form->checkBox($model1,'visible_p',array('style'=>'','id'=>'visible_pe'));?>
                                                     ...
                                                     <?php echo $form->checkBox($model1,'visible_s',array('style'=>'','id'=>'visible_se'));?>
                                                     <?php echo $form->error($model1,'visible_s'); ?><?php echo Yii::t('app','Visible to Students'); ?>

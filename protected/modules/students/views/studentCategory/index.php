			...
			{?>
                    ...
                    <div class="edit_bttns" style="right:15px; top:12px;">
                       ...
                       ?>
                        <ul>
                        <li>
                               <?php echo CHtml::link('<span>'. Yii::t('app','Create New Category').'</span>', array('#'),array('id'=>'add_student-categories','class'=>'addbttn last')) ?>
                                </li>
                        </ul>
                        <div class="clear"></div>
                       </div><div id="success_flash" align="center" style=" color:#F00; display:none;"><h4><?php echo Yii::t('app','Selected category Deleted Successfully!'); ?></h4>
                        ...
                        <td align="center" class="act"><div style="position:relative"><span class="action_but" id="<?php echo $data->id ?>"></span>
                            <div class="gridact_drop" id="<?php echo $data->id ?>a">
                                ...
                                <ul>
                                    ...
                                    <li><a href="<?php echo $data->id ?>" class="gredit"><?php echo Yii::t('app','Edit'); ?></a></li>
                                    <li><a href="<?php echo $data->id ?>" class="grdel"><?php echo Yii::t('app','Delete'); ?></a></li>
                                </ul>
                            </div>
                        </div>
                        </td>

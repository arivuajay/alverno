...
<?php   $formId='student-categories-form';
   ...
   ($model->isNewRecord)?CController::createUrl('studentCategory/ajax_create')
    ...
    <div class="row">
            <?php echo $form->labelEx($model,'name',array('style'=>'float:left;color:#444444;')); ?> <br />
            <span style="float:left; display:inline; padding-left:40">
            <?php echo $form->textField($model,'name',array('size'=>60,'maxlength'=>255,'style'=>'width:90%;')); ?></span>

...
<!--<div class="lsearch_bar">
        ...
        <?php	
			...
			$countof_student_pendinglist = Yii::app()->db->createCommand()
				  ->select("*")
				  ->from('students')
				  ->where('status=:status and is_completed=:is_completed and academic_yr=:academic_yr and is_online=:is_online and type=:type', array(':status'=>0,':is_completed'=>3,':academic_yr'=>$academic_yr->config_value,':is_online'=>1,':type'=>1))
				  ->queryAll();

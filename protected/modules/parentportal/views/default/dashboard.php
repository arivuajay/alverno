...
.tooltip-example ul{ margin:0px; padding:0px}
.tooltip-example ul li a{ color:#636e7b}
...
<?php $settings=UserSettings::model()->findByAttributes(array('user_id'=>1)); ?>
 ...
 <div class="pageheader">
     ...
     <div class="panel panel-default">
            <div class="panel-heading">
              <?php
			    if(isset($_REQUEST['id'])){
					$student_detail = Students::model()->findByAttributes(array('id'=>$_REQUEST['id']));
				}
			  ?>
              <h4 class="panel-title">
			  	<?php echo Yii::t('app','Child'); ?> : <?php if($student_detail!=NULL and $student_detail->studentFullName('forParentPortal')!=''){echo $student_detail->studentFullName('forParentPortal');} ?>
                </h4>
			...
			$criteria->params = array(':guardian_id'=>$parent->id,':is_active'=>1,'is_deleted'=>0);
			$wards = Students::model()->findAll($criteria);
			
			foreach($wards as $ward)
			{	
				if($ward->studentFullName('forParentPortal')!=''){			
					echo '<li  class="btn btn-default tooltips" title="" data-original-title="'.$ward->studentFullName('forParentPortal').'">'.CHtml::link($ward->studentFullName('forParentPortal'), array('dashboard','id'=>$ward->id)).'</li>';
				}
				$check_uid[] = $ward->id;
			}
    ...
    <?php } ?>
            ...
            <div class="table-responsive"  style=" height:520px ;overflow:hidden;">
            <div class="panel-heading">
              <!--<div class="panel-btns">
                <a class="panel-close" href="#">×</a>
                <a class="minimize" href="#">−</a>
        ...
        <?php 
		if(isset($_REQUEST['id']))
		$roles = Rights::getAssignedRoles($_REQUEST['id']); // check for single role
		else
...
<div id="jobDialog"></div>
	   ...
	   <?php 
        ...
        { 
		$student = Students::model()->findByAttributes(array('id'=>$student_user_id)) ;
        ...
        ?> 
            ...
            <div class="col-md-4">
            <div class="people-item" style="height:463px; ">
            <div class="table-responsive">
            <div class="panel-heading">
              <!--<div class="panel-btns">
                <a class="panel-close" href="#">×</a>
  ...
  <?php 
		...
		?> 
			...
			{?>
            <div class="col-md-4">
            <div class="people-item" style="height:463px; overflow:hidden;">
            <div class="table-responsive">
            <div class="panel-heading">
              <!--<div class="panel-btns">
	...
	if(isset($student_user_id))
	{
		...
		?>
		 ...
		 ?>
            ...
            <div class="table-responsive scrollbox4">

    ...
    <div class="col-lg-2"> 
				...
				?>
                    <div class="student_dropdown" style="top:15px;">
                        <?php
                        echo CHtml::dropDownList('sid','',$student_list,array('id'=>'studentid','class'=>'form-control input-sm mb14','style'=>'width:auto;','options'=>array($_REQUEST['id']=>array('selected'=>true)),'onchange'=>'getstudent();'));
                        ?>
            ...
            <div class="people-item">
                <div class="table-responsive">                
                    ...
                    <tr>
                        ...
                        <th><?php echo Yii::t('app','Class Average');?></th>
                    </tr>
                    <?php
                    if($exam==NULL)
                    {

...
?>
	<div class="event_viewbx">
        ...
        <div class="e_pop_top">
                 ...
                 <?php echo Yii::t('app','Type'); ?>: <span><?php echo ucfirst($event_type->name);?></span></div>
        ...
        <div class="e_pop_bttm">
			...
			?>
        	<span><?php if($event->placeholder == '0'){ echo Yii::t('app','Public'); }else{ echo ucfirst($event->placeholder);  } ?></span></div>
            </div>
            <div class="clear"></div>
        </div>

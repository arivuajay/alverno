  <div id="parent_leftSect">
			...
			{
				echo CHtml::link(Yii::t('app','Messages'),array('/portalmailbox'),array('class'=>'mssg_active'));
			}
			else
			{
				echo CHtml::link(Yii::t('app','Messages'),array('/portalmailbox'),array('class'=>'mssg'));
			}
			?>
           </li>
           ...
           <li>
			...
			{
				echo CHtml::link(Yii::t('app','News'),array('/portalmailbox/news'),array('class'=>'news_active'));
			}
			else
			{
				echo CHtml::link(Yii::t('app','News'),array('/portalmailbox/news'),array('class'=>'news'));
			}
			?>
           </li>
               <li>
      ...
      <!-- Check Status of new Student End -->   
           ...
           <?php
			...
			{
				echo CHtml::link(Yii::t('app','Course'),array('/parentportal/default/course'),array('class'=>'course_active'));
			}
			else
			{
				echo CHtml::link(Yii::t('app','Course'),array('/parentportal/default/course'),array('class'=>'course'));
			}
		   ?>
           </li>
             <li>

<div id="parent_Sect">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-calendar"></i> <?php echo Yii::t('app','Online Admission'); ?> <span><?php echo Yii::t('app','View online admission details here'); ?></span></h2>
                      ...
                      <ul>
                        <li><?php 
								...
								if($check_enable->config_value==1){
									echo CHtml::link(Yii::t('app','Add Siblings'),array('/onlineadmission/registration/step1'),array('class'=>'com_but',"target"=>"_blank")); 
								}
							?>
                        </li>
                      </ul>

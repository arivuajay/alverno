...
<div class="pageheader">
        <div class="col-lg-8">
        <h2><i class="fa fa-male"></i><?php echo Yii::t('app','Log'); ?> </h2>
        </div>
        <div class="col-lg-2">
		...
		$criteria->condition = "(parent_id LIKE :id) and (is_active LIKE :is_active) and (is_deleted LIKE :is_delete)";
		$criteria->params = array(':id'=>$guardian->id,':is_active'=>1,':is_delete'=>0);
        ...
        <div class="parentright_innercon">
            ...
            <?php
				//$student = Students::model()->findByAttributes(array('id'=>$_REQUEST['id'],'parent_id'=>$guardian->id,'is_active'=>'1','is_deleted'=>'0'));
					$criteria->condition = $criteria->condition." and (id LIKE :student_id)";
			...
			?>
                ...
                <div class="profile_details">
                    ...
                    <div class="people-item" id="delete_div_<?php echo $comment->id; ?>">
                                	<h3><?php echo $user_com->fullname; ?></h3>
                    ...
                    <h4 class="person-name">
                        <?php echo CHtml::link($student->studentFullName('forParentPortal'), array('/parentportal/default/lognotice', 'id'=>$student->id));?>
                                ...
                                <?php if(FormFields::model()->isVisible('batch_id','Students','forParentPortal')){?>
                                    ...
                                    <div class="text-muted">
                                    <?php echo Yii::t('app','Class :');?> <?php echo $batch->name;?></div>
                               <?php } ?>

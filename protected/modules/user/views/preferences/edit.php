		...
		<div class="btn-demo" style="position:relative; top:-8px; right:3px; float:right;">
			<div class="edit_bttns">
				<ul>
                     ...
                     <li><?php echo CHtml::link('<span>'.Yii::t('app','Change Password').'</span>',array('/user/accountProfile/changepassword'),array('class'=>'addbttn last'));?></li>
				</ul>
		</div>
	</div>
...
<p style="padding-left:20px;"><?php echo Yii::t('app','Fields with');?><span class="required">*</span><?php echo Yii::t('app','are required.');?></p>
	...
	<div >
		...
		<label class="col-sm-2 control-label"><?php echo $form->labelEx($model,Yii::t('app','Language'),array('style'=>'color:#222222;')); ?></label>

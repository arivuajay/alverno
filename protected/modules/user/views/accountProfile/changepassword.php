...
if(in_array(Yii::app()->user->name,$users) && $subdomain[0]=='tryopenschool'){
			...
			<div class="btn-demo" style="position:relative; top:-8px; right:3px; float:right;">
				<div class="edit_bttns">
					<ul>
			   			...
			   			<li><?php echo CHtml::link('<span>'.Yii::t('app','View').'</span>',array('/user/accountProfile'),array('class'=>'addbttn last'));?></li>
						<li><?php echo CHtml::link('<span>'.Yii::t('app','Edit Profile').'</span>',array('/user/accountProfile/edit'),array('class'=>'addbttn last'));?></li>
                        <li><?php echo CHtml::link('<span>'.Yii::t('app','Change Preferences').'</span>',array('/user/preferences/edit'),array('class'=>'addbttn last'));?></li>
	...
	<p style="padding-left:20px;"><?php echo Yii::t('app','Fields with');?><span class="required">*</span><?php echo Yii::t('app','are required.');?></p>
		...
		<div >
			...
			<label class="col-sm-2 control-label"><?php echo $form->labelEx($model,Yii::t('app','oldPassword'),array('style'=>'color:#222222;')); ?></label>
			
			<div class="col-sm-6"><?php echo $form->passwordField($model,'oldPassword',array('class'=>'form-control')); ?>
		<?php echo $form->error($model,'oldPassword'); ?></div>
			...
			<div class="form-group">
			<label class="col-sm-2 control-label"><?php echo $form->labelEx($model,Yii::t('app','New password').'<span class="required">*</span>',array('style'=>'color:#222222;')); ?></label>
			
			<div class="col-sm-6"><?php echo $form->passwordField($model,'password',array('class'=>'form-control')); ?>
		...
		<?php echo Yii::t('app',"Minimal password length 4 symbols."); ?>
			...
			<div class="form-group">
			<label class="col-sm-2 control-label"><?php echo $form->labelEx($model,Yii::t('app','verifyPassword'),array('style'=>'color:#222222;')); ?></label>
			
			<div class="col-sm-6"><?php echo $form->passwordField($model,'verifyPassword',array('class'=>'form-control')); ?>
		<?php echo $form->error($model,'verifyPassword'); ?></div>
			...
			<div class="col-sm-6"><div class="form-group"><?php echo CHtml::submitButton(Yii::t('app',"Save"),array('class'=>'btn btn-danger')); ?>
			</div></div>
			 </div>

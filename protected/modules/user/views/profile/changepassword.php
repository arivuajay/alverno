...
if(in_array(Yii::app()->user->name,$users) && $subdomain[0]=='tryopenschool'){
	...
	<div class="cont_right formWrapper usertable">
	 ...
	 <div class="edit_bttns" style="top:15px; right:20px">
		<ul>
				<li><?php echo CHtml::link('<span>'.Yii::t('app','View Profile').'</span>',array('/user/profile'),array('class'=>'addbttn last'));?></li>
				<li><?php echo CHtml::link('<span>'.Yii::t('app','Edit Profile').'</span>',array('/user/profile/edit'),array('class'=>'addbttn last'));?></li>
		</ul>
		<div class="clear"></div>
	</div>

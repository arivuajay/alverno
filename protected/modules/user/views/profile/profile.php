...
<div class="edit_bttns" style="top:15px; right:20px">
    <ul>
            ...
            <li><?php echo CHtml::link('<span>'.Yii::t('user','Edit Profile').'</span>',array('/user/profile/edit'),array('class'=>'addbttn last'));?></li>
            <li><?php echo CHtml::link('<span>'.Yii::t('user','Change Password').'</span>',array('/user/profile/changepassword'),array('class'=>'addbttn last'));?></li>
    </ul>
    <div class="clear"></div>
</div>

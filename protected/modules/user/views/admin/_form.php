...
<p style="padding-left:20px;"><?php echo Yii::t('User','Fields with');?><span class="required">*</span><?php echo Yii::t('User','are required.');?></p>
  ...
  <tr>
    <td><?php echo $form->labelEx($model,Yii::t('app','Username'),array('style'=>'float:left'));?><span class="required">*</span></td>  
  ...
  <tr>
    <td><?php echo $form->labelEx($model,Yii::t('app','Password'),array('style'=>'float:left')); ?><span class="required">*</span></td> 
  ...
  <tr>
    ...
    <td><?php echo $form->textField($model,'email',array('size'=>30,'maxlength'=>40)); ?>

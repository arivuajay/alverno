			...
			function t($message, $category = 'cms', $params = array(), $source = null, $language = null) 
{
    return $message;
			...
			'items'=>array(
					...
					array('label'=>''.Yii::t('app','General Settings').'<span>'.Yii::t('app','Manage Configurations').'</span>',  'url'=>array('/configurations/index'),'active'=> ((Yii::app()->controller->id=='configurations') && (in_array(Yii::app()->controller->action->id,array('create','index')))),'linkOptions'=>array('class'=>'gs_ico' ), 'itemOptions'=>array('id'=>'menu_1'),
					       ),
					      ...
					      // ),
					array('label'=>''.'<h1>'.Yii::t('app','Courses').' & '.Yii::t('app','Batches').'</h1>'),
					       
						array('label'=>Yii::t('app','List Courses').' & '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").'<span>'.Yii::t('app','All Courses').' & '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").' '.Yii::t('app','Details').'</span>', 'url'=>array('/courses/courses/managecourse'),'linkOptions'=>array('class'=>'lbook_ico' )),

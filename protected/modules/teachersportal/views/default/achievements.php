...
<div class="pageheader">
      <h2><i class="fa fa-arrow-circle-o-down"></i> <?php echo Yii::t('app','Rewards and Achievements').'<span>'.Yii::t('app','Rewards and Achievements here...').'</span>';?></h2>
...
<div class="people-item">
	...
	$valid_image_types = array('image/jpeg','image/png','image/gif','image/gif','image/bmp','image/jpg');
	 $documents = Achievements::model()->findAllByAttributes(array('user_id'=>Yii::app()->user->id,'user_type'=>'2'));
	 ?>           

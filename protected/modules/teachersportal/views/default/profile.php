                   ...
                   <div class="prof_img">  
                    ...
                    top:30px; left:30px"><div class="loading_app" ></div><div id="percentage" style="color:#FFF !important; font-size:14px; text-shadow:0px 0px 2px #000; color:#fff"></div></div>
                            ...
                            <div class="media-body">
                              <h4 class="person-name"><?php echo ucfirst($employee->last_name.' '.$employee->first_name);?></h4>
            ...
            <td width="10%"><ul class="tt-wrapper">
                ...
                <li>
                  <?php 
													...
													{
														echo CHtml::link('<span>'.Yii::t('app','Delete').'</span>', array('deletes','id'=>$document->id,'student_id'=>$document->employee_id),array('class'=>'tt-delete','confirm'=>Yii::t('app','Are you sure you want to delete this?'))); 
													}
													?>
                </li>
              </ul></td>
...
<script type="text/javascript">
	$('#std_image').jupload({
	 //url:'parentportal/default/studentpicupload',
	 ...
	 select:function(files){
	  $.each(files, function(index, file){
	   ...
	   reader.onload = function (e) {      
		//$container.find('.active').css('background', 'url(' + e.target.result + ')');				    
		//$('.prof_img').css('backgroundImage', 'url(' + e.target.result + ')');

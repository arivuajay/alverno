...
<script type='text/javascript' src='<?php echo Yii::app()->request->baseUrl; ?>/js/portal/fullcalendar/fullcalendar.js'></script>
      ...
      <div class="pageheader">
        <div class="col-lg-8">
        <h2><i class="fa fa-calendar"></i><?php echo Yii::t('app','Calendar'); ?><span><?php echo Yii::t("app", 'View Event Calender');?> </span></h2>
        </div>
        <div class="col-lg-2">
           ...
           <div style="position:absolute; width:auto; z-index:10; top:0px; right:25px; font-size:14px;">
			...
			$roles = Rights::getAssignedRoles(Yii::app()->user->Id); // check for single role
		     foreach($roles as $role)
		      ...
		      $cal .= '{
						title: "<span style=\" display:block;margin:0 auto;width:10px;height:10px;background-color:'.$event_type->colour_code.'\"></span>",
                  ...
                  <ul>
                            ...
                            ?>
                               <li>
                                  ...
                                  <span class="date"><?php echo $event->end; ?> </span></small>
                                    ...
                                    <small class="text-muted"><span class="more">Type : <?php echo $event_type->name; ?></span></small><br />									 
                                    <small class="text-muted"><span class="more">Time : <?php echo $event->start.' - '.$event->end; ?></span></small>
...
$(document).on('click', "span.fc-button-next,span.fc-button-prev,span.fc-button-today", function() {
	...
	var year_int = date.getFullYear();
     $.ajax({url:"<?php echo Yii::app()->createUrl('/teachersportal/default/currentevent'); ?>",
	 data:{month:month_int,year:year_int,type:"<?php if($_REQUEST['type'])echo $_REQUEST['type'];else 0;?>"},

        ...
        <div id="parent_rightSect">
                ...
                <div class="yellow_bx" style="background-image:none;width:90%;padding-bottom:45px;">
                    ...
                    <div class="y_bx_list timetable_list">
                    	<h5 class="subtitle"><?php echo Yii::t('app','View My Attendance'); ?></h5>
                        <p><?php echo Yii::t('app','Displays your attendance status.'); ?></p>
                    </div> 
                    <?php 
					if($stud_flag == 1)
					{
					?>
                    <div class="y_bx_list timetable_list">
                    	<h5 class="subtitle"><?php echo Yii::t('app','Manage Student Attendance'); ?></h5>
                        <p><?php echo Yii::t('app','View/Mark/Edit/Delete the attendance of the students of your.').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id"); ?></p>
                    </div>

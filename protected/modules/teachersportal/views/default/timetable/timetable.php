                ...
                <div class="yellow_bx">
                    <?php /*?><div class="y_bx_head" style="font-size:14px;">
                       &nbsp;
                        ...
                        <p><?php echo Yii::t('app','Displays your timetable.'); ?></p>
                    
                    <?php 
					if($stud_flag == 1){
					?>
                    
                    	<h5 class="subtitle"><?php echo Yii::t('app','View Class Timetable'); ?></h5>
                        <p><?php echo Yii::t('app','View the timetable for the class(es) that you are in charge.'); ?></p>

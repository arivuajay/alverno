...
<div>
		   ...
		   { ?>
                   ...
                   <table class="table table-bordered mb30">
					...
					?>
                        ...
                        <td><strong> <?php echo Yii::t('app','Class Teacher'); ?>: </strong><?php echo $classteacher->first_name.' '.$classteacher->last_name; ?>
    ...
    <div class="edit_bttns" style=" float:right">
        <ul>
            ...
            <li><span>
            <?php 
				echo CHtml::link('<span>'.Yii::t('app','View Exam List').'</span>', array('/teachersportal/exams/allexams','bid'=>$batch_id),array('id'=>'add_exam-groups','class'=>'addbttn')); 
			...
			?>
            <li><span>
        	<?php echo CHtml::link('<span>'.Yii::t('app','Change').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").'</span>', array('/teachersportal/exams/allexam'),array('id'=>'add_exam-groups','class'=>'addbttn')); ?>
        	</span></li>
        </ul>
        <div class="clear"></div>
    </div>

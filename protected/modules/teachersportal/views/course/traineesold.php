        ...
        <div class="table-responsive">                                  
                        <table width="95%" border="0" cellspacing="0" cellpadding="0" class="table table-hover mb30">
							...
							?>
                                ...
                                <td><?php echo $i; ?></td>
                                <td><?php echo $list_1->first_name.'  '.$list_1->middle_name.'  '.$list_1->last_name; ?></td>
								...
								<?php echo CHtml::ajaxLink(count($flags),$this->createUrl('/teachersportal/course/logdetails',array('id'=>$list_1->id)),array('update'=>'#jobDialog'),array('id'=>'showJobDialog1'.$list_1->id,'class'=>'add')); 
	
	
	?>
								<?php //echo CHtml::link(count($flags),array('logdetails','id'=>$list_1->id),array('class'=>'')); ?>
                                </td>
                                <!--<td style="border-right:none;">Task</td>-->
                                </tr>
								<?php

...
<!-- TAB -->
	...
	if($is_teacher!=NULL)
	{ 
		if(Yii::app()->controller->action->id=='elective')
		{
			echo '<li class="active">'.CHtml::link(Yii::t('app','Elective'), array('elective','id'=>$_REQUEST['id']),array('class'=>'active')).'</li>';
		}
		else
		{
			echo '<li>'.CHtml::link(Yii::t('app','Elective'), array('elective','id'=>$_REQUEST['id'])).'</li>';
		}
	}
    ?>
    <?php     

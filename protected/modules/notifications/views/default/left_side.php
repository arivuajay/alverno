...
foreach($roles as $role)
	...
	<div id="othleft-sidebar">
        ...
        'items'=>array(
            ...
            array('label'=>Yii::t('app', 'New Compose').'<span>'.Yii::t('app', 'Send an email').'</span>', 'url'=>array('/notifications/default/sendmails'),'linkOptions'=>array('class'=>'compose_1'),'active'=> (Yii::app()->controller->action->id=='sendmails')),
			...
			array('label'=>Yii::t('app', 'Generate Contact').'<span>'.Yii::t('app', 'Generate contacts').'</span>', 'url'=>array('/notifications/default/parentcontacts'),'linkOptions'=>array('class'=>'sent_import')),
			),
        )); ?>

...
<?php $this->renderPartial('//assesments/left_side');?>
    ...
    <div align="right" style="width:60%"><?php echo CHtml::link(Yii::t('app','New'), array('create', 'id'=>$_REQUEST['id']),array('class'=>'cbut')); ?></div>
    <br />
...
<?php $posts=ExamGroups::model()->findAll("batch_id=:x", array(':x'=>$_REQUEST['id']));
	  foreach($posts as $posts_1)
	  {
		  ...
		  echo '<td>'.CHtml::link(Yii::t('app','Delete'), array('ExamGroups/deletenew', 'id'=>$posts_1->id,'ret'=>$_REQUEST['id'])).'</td>';
		  echo '</tr>';
	  }
 ?>
 </table>

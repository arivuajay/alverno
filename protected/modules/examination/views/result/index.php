...
<table width="85%" border="0" cellspacing="0" cellpadding="0" class="s_search">
            ...
            <tr>
                ...
                ?>
                <?php
                 echo CHtml::dropDownList('search_id','',array('1'=>Yii::t('app','Course'),'2'=>Yii::t('app','Student')),array('prompt'=>Yii::t('app','Select'),'style'=>'width:100px;','onchange'=>'getsearch()','id'=>'search_id','options'=>array($_REQUEST['search_id']=>array('selected'=>true))));	?></td>
             ...
             <tr>
                ...
                <tr style=" <?php echo $batch_style; ?> ">
                 ...
                 <td ><?php echo Yii::t('app','Exam Group');?></td>
                 <td ><?php echo Yii::t('app','Exam');?></td>
                </tr>
                <tr style=" <?php echo $batch_style; ?> ">
                 <td >&nbsp;</td>
                 <td >&nbsp;</td>
                ...
                <?php 
                    ...
                    'update'=>'#batch_id',
                    'data'=>'js:$(this).serialize()'),'style'=>'width:150px;','options' => array($course=>array('selected'=>true),)));
                ...
                ?>
                 ...
                 <td> 
                    ...
                    'update'=>'#group_id',
                    'data'=>'js:$(this).serialize()',),'style'=>'width:150px;','options' => array($batch=>array('selected'=>true))));
                   ?>
                </td>
                 ...
                 <td> 
                    ...
                    'update'=>'#exam_id',
                    'data'=>'js:$(this).serialize()',),'style'=>'width:150px;','options' => array($group=>array('selected'=>true))));
                   ?>
                </td>
                 ...
                 <td> 
                    ...
                    'style'=>'width:150px;','options' =>array($exam=>array('selected'=>true))));
                   ?>
                </td>
            </tr>
            ...
            <tr id="student_data" style=" <?php echo $course_style; ?> ">
                                ...
                                <td><div style="position:relative; width:180px" >
                                    ...
                                    <div id="std_name_error" style="color:#F00"></div>
                                    </td>
                                <td></td>
								<td></td>

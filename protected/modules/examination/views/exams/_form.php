                            ...
                            foreach($posts as $posts_1)
                            {
                                ...
                                if($checksub==NULL)
                                {
                                    if($j==0)
                                    {
                                        ...
                                        echo $form->textField($model,'max_mark',array('id'=>'max_mark','maxlength'=>3,'onblur'=>'new_1('.count($posts).');'));
										?>
                                        ...
                                        echo $form->textField($model,'min_mark',array('id'=>'min_mark','maxlength'=>3,'onblur'=>'old_1('.count($posts).');'));
										?>
                                    ...
                                    <tr>
                                        <th width="140"><?php echo Yii::t('app','Subject name');?></th>
                                        <th><?php echo Yii::t('app','Max Marks');?></th>
                                        <th><?php echo Yii::t('app','Min Marks');?></th>

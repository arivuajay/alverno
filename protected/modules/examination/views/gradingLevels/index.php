    ...
    <tr>
        ...
        <td valign="top">
            ...
            <div class="cont_right formWrapper">
                <h1><?php echo Yii::t('app','Set Grading Levels');?></h1>
                <div style="position:relative">
                    <div class="edit_bttns" style="width:250px; top:-40px; right:-125px;">
                        <ul>
                            <li>
                            <?php echo CHtml::link('<span>'.Yii::t('app','Assessments').'</span>', array('/examination/exam','id'=>$_REQUEST['id']),array('class'=>'addbttn last'));?>
                            </li>
                        </ul>
                        <div class="clear"></div>
                    </div>

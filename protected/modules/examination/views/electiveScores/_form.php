...
<?php $i=1;
	...
	<tr>
		...
		<?php echo $form->hiddenField($model,'student_id[]',array('value'=>$posts_1->student_id,'id'=>$posts_1->student_id)); ?></td>
		

	
		<td><?php echo $form->textField($model,'marks[]',array('size'=>7,'maxlength'=>3,'id'=>$posts_1->student_id)); ?></td>
...
{?>
    ...
    <ul>
    <li>
    <?php echo CHtml::link('<span>'.Yii::t('app','Clear All Scores').'</span>', array('electiveScores/deleteall','id'=>$_REQUEST['id'],'examid'=>$_REQUEST['examid'],'elective'=>$_REQUEST['elective']),array('class'=>'addbttn last','confirm'=>Yii::t('app','Are You Sure? All Scores will be deleted.')));?>
    </li>

    ...
    width: 100%;
     ...
     <div class="pageheader">
    	...
    	<div class="people-item">
			...
			$timing = ClassTimings::model()->findAll("batch_id=:x", array(':x'=>$student->batch_id)); // Display pdf button only if there is class timings.
			if($timing!=NULL){
				echo CHtml::link(Yii::t('app','Generate PDF'), array('Default/pdf','id'=>$student->batch_id),array('class'=>'btn btn-danger pull-right','target'=>'_blank'));
			} 
			...
			$criteria->params = array(':x'=>$student->batch_id);
...
$sets =  TimetableEntries::model()->findAllByAttributes(array('batch_id'=>$student->batch_id,'weekday_id'=>$weekdays[0]['weekday'],'class_timing_id'=>$timing[$i]['id']));
				if(count($sets)==0)
				{
				...
				else
				{
					echo ucfirst($time_sub->name).'<br>';
                                                echo ucfirst($time_emp->first_name);
				}
				}
					...
					else
					{
						?><div class="employee"><?php
							...
							//echo '<div class="employee">'.'<b>'.ucfirst($elec_group->name).'<br>'.ucfirst($time_sub->name).'</b><br>'.$time_emp->first_name.'</div>';
                                                    $is_exist_elective = StudentElectives::model()->findByAttributes(array('student_id'=>$student->id,'batch_id'=>$student->batch_id,'elective_group_id'=>$elec_group->id,'elective_id'=>$time_sub->id));
			  ...
			  for($i=0;$i<$count_timing;$i++)
			  {
				echo ' <td class="td">
						<div  onclick="" style="position: relative; ">
						  <div class="tt-subject">
							<div class="subject">';
		$sets =  TimetableEntries::model()->findAllByAttributes(array('batch_id'=>$student->batch_id,'weekday_id'=>$weekdays[1]['weekday'],'class_timing_id'=>$timing[$i]['id']));           
				if(count($sets)==0)
				{
					$is_break = ClassTimings::model()->findByAttributes(array('id'=>$timing[$i]['id'],'is_break'=>1));
					if($is_break!=NULL)
			  ...
			  for($i=0;$i<$count_timing;$i++)
			  {
				echo ' <td class="td">
						<div  onclick="" style="position: relative; ">
						  <div class="tt-subject">
							<div class="subject">';
							$sets =  TimetableEntries::model()->findAllByAttributes(array('batch_id'=>$student->batch_id,'weekday_id'=>$weekdays[2]['weekday'],'class_timing_id'=>$timing[$i]['id']));
        ...
        <td class="td"><div class="name"><?php echo '<strong>'.Yii::t('app','WED').'</strong>';?></div></td>
         ...
         <?php
			...
			/*echo "weekday".$weekdays[3]['weekday'];
			  echo "class timing".$timing[$i]['id'];
			echo "employee".$employee->id;exit;*/
				$sets =  TimetableEntries::model()->findAllByAttributes(array('batch_id'=>$student->batch_id,'weekday_id'=>$weekdays[3]['weekday'],'class_timing_id'=>$timing[$i]['id']));
				if(count($sets)==0)
				{
					$is_break = ClassTimings::model()->findByAttributes(array('id'=>$timing[$i]['id'],'is_break'=>1));
					if($is_break!=NULL)
			  ...
			  for($i=0;$i<$count_timing;$i++)
			  {
				echo ' <td class="td">
						<div  onclick="" style="position: relative; ">
						  <div class="tt-subject">
							<div class="subject">';
				$sets =  TimetableEntries::model()->findAllByAttributes(array('batch_id'=>$student->batch_id,'weekday_id'=>$weekdays[4]['weekday'],'class_timing_id'=>$timing[$i]['id']));
				if(count($sets)==0)
				{
					$is_break = ClassTimings::model()->findByAttributes(array('id'=>$timing[$i]['id'],'is_break'=>1));
					if($is_break!=NULL)
			  ...
			  for($i=0;$i<$count_timing;$i++)
			  {
				echo ' <td class="td">
						<div  onclick="" style="position: relative; ">
						  <div class="tt-subject">
							<div class="subject">';
				$sets =  TimetableEntries::model()->findAllByAttributes(array('batch_id'=>$student->batch_id,'weekday_id'=>$weekdays[5]['weekday'],'class_timing_id'=>$timing[$i]['id']));
				if(count($sets)==0)
				{
					$is_break = ClassTimings::model()->findByAttributes(array('id'=>$timing[$i]['id'],'is_break'=>1));
					if($is_break!=NULL)
			  ...
			  for($i=0;$i<$count_timing;$i++)
			  {
				echo ' <td class="td">
						<div  onclick="" style="position: relative; ">
						  <div class="tt-subject">
							<div class="subject">';
							$sets =  TimetableEntries::model()->findAllByAttributes(array('batch_id'=>$student->batch_id,'weekday_id'=>$weekdays[6]['weekday'],'class_timing_id'=>$timing[$i]['id']));
				if(count($sets)==0)
				{
					$is_break = ClassTimings::model()->findByAttributes(array('id'=>$timing[$i]['id'],'is_break'=>1));
					if($is_break!=NULL)

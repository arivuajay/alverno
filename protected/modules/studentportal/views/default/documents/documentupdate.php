            ...
            <div class="people-item">	
                ...
                <div class="btn-demo" style="position:relative; top:-20px; right:3px; float:right;">
                	<div class="edit_bttns">
                        <ul>
                            <li><span>
                                <?php echo CHtml::link(Yii::t('app','Student Profile'), array('profile'),array('class'=>' edit ')); ?>
                           </span> </li>
                        </ul>
                	</div> 
                    </div>
					...
					<?php $form=$this->beginWidget('CActiveForm', array(
                        ...
                        <div class="formCon" style="clear:left;">
                            <div class="formConInner" id="innerDiv">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="documentTable">
                                    <tr>
                                        <td><?php echo $form->labelEx($model,Yii::t('app','Document Name'),array('style'=>'float:left;')); //need translation ?><span class="required">&nbsp;*</span></td>
                                        <td>&nbsp;</td>
                        ...
                        <div class="row buttons" style="margin: 10px 0;">
                            ...
                            <?php echo CHtml::submitButton(Yii::t('app','Update'),array('class'=>'btn btn-danger','submit'=>array('default/documentupdate','document_id'=>$model->id,'id'=>$model->student_id))); ?>
                        </div>

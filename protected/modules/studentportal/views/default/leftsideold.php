        ...
        <div class="visible-xs hidden-sm hidden-md hidden-lg">   
            <div class="media userlogged">
            	 ...
            	 <?php
						 ...
						 { 
							echo '<img  src="'.$this->createUrl('/students/Students/DisplaySavedImage&id='.$student->primaryKey).'" alt="'.$student->photo_file_name.'"  width="40" height="41" />';
						}
         ...
         <ul class="nav nav-pills nav-stacked nav-bracket">
          <li>
           ...
           <?php
			...
			{
				echo '<li class="active">';
				echo CHtml::link('<i class="fa fa-arrow-circle-o-down"></i> <span>'.Yii::t('app','Downloads').'</span>',array('/downloads/students'));
				echo '</li>';
			}
			else
			{
           ...
           <?php
			...
			{
				echo '<li class="active">';
				echo CHtml::link('<i class="fa fa-money"></i> <span>'.Yii::t('app','Fees').'</span>',array('/studentportal/default/fees'));
				echo '</li>';
			}
			else
			{
           ...
           <?php
			...
			{
				echo '<li class="active">';
				echo CHtml::link(Yii::t('studentportal','<i class="fa fa-shield"></i> <span>Rewards & Achievements</span>'),array('/studentportal/default/achievements'));
				echo '</li>';
			}
			else
			{
           ...
           <?php
			...
			{
				echo '<li class="active">';
				echo CHtml::link('<i class="glyphicon glyphicon-log-in"></i> <span>'.Yii::t('app','Log').'</span>',array('/studentportal/default/lognotice'));
				echo '</li>';
			}
			else
			{
		   ...
		   ?>
              ...
              <li>
           <?php
		   		if(Yii::app()->controller->action->id=='manage' || Yii::app()->controller->action->id=='booksearch' || (Yii::app()->controller->id=='authors' and Yii::app()->controller->action->id=='authordetails'))
			{
				echo '<li class="active">';
				echo CHtml::link('<i class="fa fa-folder-open"></i> <span>'.Yii::t('app','Library').'</span>',array('/library/book/manage'));
				echo '</li>';
			}
			else
			{
		   ...
		   ?>
             ...
             <li>
           <?php
		   		if((Yii::app()->controller->module->id=='hostel' && Yii::app()->controller->action->id=='index') || Yii::app()->controller->id=='room')
			{
				echo '<li class="active">';

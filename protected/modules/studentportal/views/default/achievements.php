...
<div class="people-item">
	 ...
	 $documents = Achievements::model()->findAllByAttributes(array('user_id'=>Yii::app()->user->id,'user_type'=>'1'));
	 ?>           
        ...
        <li>
           ...
           <?php echo CHtml::link('<span>'.Yii::t('app','Download').'</span>', array('achievementdownload','id'=>$document->id),array('class'=>'tt-download'));?>
            ...
            if(in_array($document->file_type,$valid_image_types)) 
            {
				...
				echo '<li>
                                                             	<a class="tt-image" href="#"><span style="width:200px;height:170px; left:-30px;"><img  src="'.$path.'" width="170" height="140" /></span></a>	</li>';
			}
		?>
       </ul>
        </td>

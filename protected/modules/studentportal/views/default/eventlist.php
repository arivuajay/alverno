...
<script>
	function getType()
	{
		...
		if(eventid == '')
		{
			window.location= 'index.php?r=studentportal/default/eventlist';
		}
		else
		{
			window.location= 'index.php?r=studentportal/default/eventlist&type='+eventid;
		}
	}
</script>
...
<script type='text/javascript' src='<?php echo Yii::app()->request->baseUrl; ?>/js/portal/fullcalendar/fullcalendar.js'></script>
     ...
     <div class="contentpanel">
    	...
    	<div class="people-item" style="padding-top:40px;">
...
$(document).on('click', "span.fc-button-next,span.fc-button-prev,span.fc-button-today", function() {
	...
	var year_int = date.getFullYear();
     $.ajax({url:"<?php echo Yii::app()->createUrl('/studentportal/default/currentevent'); ?>",

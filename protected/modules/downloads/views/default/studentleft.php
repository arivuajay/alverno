  <div id="parent_leftSect">
         ...
         <li>
			...
			{
				echo CHtml::link(Yii::t('app','Calender'),array('/studentportal/default/eventlist'),array('class'=>'cal_active'));
			}
			else
			{
				echo CHtml::link(Yii::t('app','Calender'),array('/studentportal/default/eventlist'),array('class'=>'cal'));
			}
         ...
         <li>
		   ...
		   ?>
              ...
              <li>
           <?php
		   		if(Yii::app()->controller->module->id== 'hostel' and (Yii::app()->controller->action->id=='index' || Yii::app()->controller->action->id=='change'))
			{

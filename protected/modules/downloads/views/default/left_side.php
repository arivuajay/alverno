...
<div id="othleft-sidebar">
			...
			array('label'=>Yii::t('app','All Uploads').'<span>'.Yii::t('app','View All File Uploads').'</span>', 'url'=>array('/downloads'),'active'=> (((Yii::app()->controller->module->id=='downloads' and Yii::app()->controller->id=='fileUploads' and Yii::app()->controller->action->id=='index') or (Yii::app()->controller->module->id=='downloads' and Yii::app()->controller->id!='fileUploads' and Yii::app()->controller->id!='filecategory')) ? true : false),'linkOptions'=>array('class'=>'upld_all_ico')),
			array('label'=>Yii::t('app','Create File Uploads').'<span>'.Yii::t('app','Create File Uploads').'</span>' , 'url'=>array('fileUploads/create'),'active'=> ((Yii::app()->controller->module->id=='downloads' and Yii::app()->controller->id=='fileUploads'and Yii::app()->controller->action->id=='create') ? true : false),'linkOptions'=>array('class'=>'upld_create')),
			...
			array('label'=>Yii::t('app','Create File Category').'<span>'.Yii::t('app','Create File Categories').'</span>', 'url'=>array('/downloads/fileCategory/create'),'active'=> ((Yii::app()->controller->module->id=='downloads' and Yii::app()->controller->id=='fileCategory' and Yii::app()->controller->action->id=='create') ? true : false),'linkOptions'=>array('class'=>'file_cat')),	

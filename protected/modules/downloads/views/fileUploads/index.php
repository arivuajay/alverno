...
.pdtab_Con table td{ padding:8px;}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <tr class="pdtab-h">
    <td width="50"><input id="demo_box_1" class="css-checkbox" type="checkbox" /><label for="demo_box_1" name="demo_lbl_1" class="css-label"></label><input type="hidden" id="isChkd" value="true" /></td>
    <td align="center"><?php echo Yii::t('app','Title'); ?></td>
    <td align="center"><?php echo Yii::t('app','File Name'); ?></td>
    <td align="center"><?php echo Yii::t('app','File Type'); ?></td>
    <td align="center"><?php echo Yii::t('app','Posted By'); ?></td>
    </tr>
    <?php
	if($files!=NULL)
	{

...
<div class="pageheader">
      <h2><i class="fa fa-arrow-circle-o-down"></i> <?php echo Yii::t('app','Downloads'); ?> <span><?php echo Yii::t('app','Downloads here'); ?>...</span></h2>
...
<div class="panel-heading" style="position:relative;">
 ...
 <?php
	...
	foreach($roles as $role)
	{
		...
		<?php 
         echo CHtml::link(Yii::t('app','New Upload'),array('create'),array('class'=>'btn btn-success',array('style'=>'margin-right:10px;'),));

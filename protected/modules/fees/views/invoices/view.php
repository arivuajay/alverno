                ...
                <tr>
                    <td valign="top" width="75%">
                        <div class="cont_right formWrapper">
                            ...
                            <div class="edit_bttns" style="width:141px; top:15px;">
                            ...
                            <div style="width:97%; padding-top:0px;" class="pdtab_Con" >
								...
								<div class="invoice-table">                                    
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0" id="invoice-particualrs">
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td colspan="6" align="right" style="padding-right:10px;"><strong><?php echo Yii::t('app','Sub Total').(($configuration!=NULL)?" (".$configuration->config_value.")":''); ?></strong></td>
                                                <td align="center"><?php echo number_format($sub_total, 2);?></td>
                                            </tr>
                                            <tr>
                                                <td colspan="6" align="right" style="padding-right:10px;"><strong><?php echo Yii::t('app','Discount').(($configuration!=NULL)?" (".$configuration->config_value.")":''); ?></strong></td>
                                                <td align="center"><?php echo ($discount_total!=0)?number_format($discount_total, 2):"-";?></td>
                                            </tr>
                                            <tr>
                                                <td colspan="6" align="right" style="padding-right:10px;"><strong><?php echo Yii::t('app','Tax').(($configuration!=NULL)?" (".$configuration->config_value.")":''); ?></strong></td>
								...
								?>
                                <a href="javascript:void(0);" class='formbut edit-particulars' style='height:15px; float:right;'><?php echo Yii::t("app", "Edit");?></a>
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                        <tbody>
                                            ...
                                            if($invoice->is_canceled==0)                                                
                                                ...
                                                ?>
                                                <tr>
                                                    <td align="center" colspan='9'><?php echo Yii::t('app', 'No data found');?></td>
                                                </tr>
                                                <?php
                                            }
                                            ?>

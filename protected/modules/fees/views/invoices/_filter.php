...
$criteria	= new CDbCriteria;
$criteria->compare("academic_yr_id", $year);
$categories	= FeeCategories::model()->findAll($categories);
...
<table width="98%">	
    ...
    <tr>
        ...
        <td><?php echo $form->dropDownList($search, 'is_paid', array(1=>Yii::t("app", "Paid"), 0=>Yii::t("app", "Unpaid")), array("prompt"=>Yii::t("app", "All")));?></td>
        <td>
			<?php

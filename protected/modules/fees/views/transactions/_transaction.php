<tr <?php if($transaction->is_deleted==1 and $transaction->deleted_by!=NULL){?>style="text-decoration:line-through;" title="Removed by `<?php echo $ctransaction->deletedUser;?>`" <?php } ?>>
    ...
    <td align="center"><a href="javascript:void(0);" data-transaction-id="<?php echo $transaction->id;?>" class="remove-transaction"><?php echo Yii::t("app", "Remove");?></a></td>
</tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
												...
												if(count($subscriptions)==0){
													...
													echo " | ";
													echo CHtml::link(Yii::t("app", "Remove"), array("/fees/remove", 'id'=>$category->id), array('title'=>Yii::t("app", "Remove this fee category"), 'confirm'=>Yii::t('app', 'Are you sure remove this fee category ?')));
												}
												else{

            ...
            <div class="cont_right">
				...
				?>
                    <div class="edit_bttns" style="top:20px; right:20px;">
                        <ul>
                        <li> <?php echo CHtml::link('<span>'.Yii::t('app','Enter Route Details').'</span>',array('/transport/RouteDetails/create'),array('class'=>'addbttn last ')); ?></li>
                        ...
                        if($route!=NULL)
                        {
							...
							<tr>
								...
								<td align="center">
									...
									{
									echo CHtml::link(Yii::t('app','Delete'),array('/transport/RouteDetails/deletedetails','id'=>$route_1->id),array('confirm'=>Yii::t('app','Are you sure?')));
									}
									?>
								</td>
								<?php

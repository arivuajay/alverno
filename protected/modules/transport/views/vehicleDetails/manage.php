            ...
            <div class="cont_right">
				...
				?>
                    <div class="edit_bttns" style="top:20px; right:20px;">
                        <ul>
                            <li> <?php echo CHtml::link('<span>'.Yii::t('app','Enter Vehicle Details').'</span>',array('/transport/vehicleDetails/create'),array('class'=>'addbttn last ')); ?></li>
                        </ul>
							...
							?>
								<tr>
									...
									?>
                                        ...
                                        {
                                            echo CHtml::link(Yii::t('app','Delete'),array('/transport/vehicleDetails/deletedetails','id'=>$vehicle_1->id),array('confirm'=>Yii::t('app','Are you sure?')));
                                        }
                                        ?>
                                        </td>
                                    <?php

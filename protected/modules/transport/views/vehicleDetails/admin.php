...
$this->menu=array(
	array('label'=>Yii::t('app','List VehicleDetails'), 'url'=>array('index')),
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('vehicle-details-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
?>
         ...
         <h1><?php echo Yii::t('app','Manage Vehicle Details');?></h1>

            ...
            <div class="cont_right">
				...
				?>
                    <div class="edit_bttns" style="top:20px; right:20px;">
                        <ul>
                        <li> <?php echo CHtml::link('<span>'.Yii::t('app','Enter Driver Details').'</span>',array('/transport/DriverDetails/create'),array('class'=>'addbttn last ')); ?></li>
                        </ul>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        if($drive!=NULL)
                        {
							...
							<tr>
                                ...
                                {
                                    echo CHtml::link(Yii::t('app','Delete'),array('/transport/DriverDetails/deletedetails','id'=>$drive_1->id),array('confirm'=>Yii::t('app','Are you sure?')));
                                }
                                ?>
                                </td>
                                <?php

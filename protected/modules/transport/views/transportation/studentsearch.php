									  ...
									  ?> 
                                       ...
                                       <?php } ?>     
										...
										<td align="center">
											...
											{
												echo CHtml::link(Yii::t('app','Edit'),array('/transport/transportation/reallot','id'=>$list_1->id));
											}
											if($edit_n_delete ==1)
											{
												echo ' | ';
											...
											{
												echo CHtml::link(Yii::t('app','Remove'),array('/transport/transportation/remove','id'=>$list_1->id),array('confirm'=>Yii::t('app','Are you sure?')));
											}
											?>
										</td>
										<?php

        ...
        <td valign="top"> 
            <div class="cont_right">
                ...
                <div class="edit_bttns" style="top:20px; right:20px;">
                    <ul>
                    	<li> <?php echo CHtml::link('<span>'.Yii::t('app','Create New Bus Log').'</span>',array('/transport/BusLog/create'),array('class'=>'addbttn last ')); ?></li>
                    </ul>
                        ...
                        if($route!=NULL)
                        {
							...
							<tr>
								...
								<td align="center">
									...
									{
									echo CHtml::link(Yii::t('app','Delete'),array('/transport/BusLog/delete','id'=>$route_1->id),array('confirm'=>Yii::t('app','Are you sure, you want to delete this bus logo?')));
									}
									?>
								</td>
								<?php

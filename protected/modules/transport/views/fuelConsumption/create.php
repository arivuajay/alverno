    ...
    <tr>
        ...
        <td valign="top"> 
            <div class="cont_right">
                <h1><?php echo Yii::t('app','Record Fuel Consumption');?></h1>
                <?php
                ...
                <div>
                    <div class="yellow_bx" style="background-image:none;width:95%;padding-bottom:45px;">
                        ...
                        <?php 
                            ...
                            echo Yii::t('app','To record fuel consumption details, enable the Create option in Previous Academic Year Settings.');	
                        ?>
                        </div>

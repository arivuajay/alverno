...
$this->menu=array(
	array('label'=>Yii::t('app','List FuelConsumption'), 'url'=>array('index')),
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('fuel-consumption-grid', {
		data: $(this).serialize()
	});
	return false;
});
");
?>
 <h1><?php echo Yii::t('app','Manage FuelConsumption');?></h1>

...
$this->menu=array(
	array('label'=>Yii::t('app','List StopDetails'), 'url'=>array('index')),
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('stop-details-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
?>
 ...
 <h1><?php echo Yii::t('app','Manage Stop Details');?></h1>

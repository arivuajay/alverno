				...
				?>
                    <div class="edit_bttns" style="top:20px; right:20px;">
                        <ul>
							...
							{
							?>
                            <li> <?php echo CHtml::link('<span>'.Yii::t('app','Edit Stops').'</span>',array('update','id'=>$_REQUEST['id'])); ?></li>
                            <?php
							}
							?>
                            <?php
							...
							{
							?>
                            <li> <?php echo CHtml::link('<span>'.Yii::t('app','Remove All Stops').'</span>',array('removeall','id'=>$_REQUEST['id']),array('confirm'=>Yii::t('app','Are you sure you want to delete this stop details?'))); ?></li>
                            <?php
							}
							?>
                        </ul>
				...
				?>
                    <table>
                        <tr>
                            ...
                            <td><input type="submit" class="formbut" value="Go" onclick="return checkStops();" /></td>
                            <td>
                                    <?php
                    ...
                    foreach($stop as $stop_1)
                    {
						...
						<tr>
							...
							<td align="center">
								...
								if(($year == $current_academic_yr->config_value) or ($year != $current_academic_yr->config_value and $is_delete->settings_value!=0))
								{
								echo CHtml::link(Yii::t('app','Remove'),array('stopDetails/remove','id'=>$stop_1->id),array('onclick'=>'if(confirm("'.Yii::t('app','Remove stop').'"'.$stop_1->stop_name.' ?")){}else{return false;}')
                                    );
								}
                                ?>
							</td>

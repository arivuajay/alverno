...
class VehicleDetailsController extends RController
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','manage','deletedetails'),
				'users'=>array('*'),
			),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['VehicleDetails']))
		{
			...
			$model->attributes=$_POST['VehicleDetails'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('VehicleDetails');
	...
	{
		$model=new VehicleDetails('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['VehicleDetails']))
			$model->attributes=$_GET['VehicleDetails'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='vehicle-details-form')
		{

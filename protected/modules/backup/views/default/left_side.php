...
<div id="othleft-sidebar">
			...
			'items'=>array(
					...
					array('label'=>''.Yii::t('app','Upload Backup').'<span>'.Yii::t('app','Upload New Backup').'</span>',  'url'=>array('default/upload'),'linkOptions'=>array('class'=>'vsd_ico'),'active'=> (Yii::app()->controller->action->id=='upload')),

...
<div class="contact_box_group"></div>
    ...
    <div class="con_bottom">    
    	<div style="margin:2px 0px 0 8px">			
            <?php echo CHtml::link(Yii::t('app', 'Edit'), array('update', 'id'=>$data->id),array('class'=>'formbut_yellow'));?>
			<?php echo CHtml::link(Yii::t('app', 'Delete'), array('delete', 'id'=>$data->id),array('class'=>'formbut_yellow', 'confirm'=>Yii::t('app', 'Are you sure ?')));?>
            <?php echo CHtml::link(Yii::t('app', 'Contacts'), array('/sms/contacts', 'group'=>$data->id),array('class'=>'formbut_yellow'));?>
        </div>
    </div>
</div>

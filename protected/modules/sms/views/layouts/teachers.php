...
<html>
    ...
    <body>
        ...
        <header>
            ...
            <div class="loginBox">
                ...
                <li>
                    ...
                    <?php echo CHtml::link(Yii::t('teachersportal','My Account'),array('/teachersportal/default/profile'),array('class'=>'profile')); ?> <br/>
					<?php echo CHtml::link(Yii::t('teachersportal','Settings'),array('/user/profile'),array('class'=>'profile')); ?>
        ...
        <footer>
            <div class="fright">
                <div class="cright">Copyright © <?php echo date('Y').' '.$college->config_value ; ?>. Powered By <a href="http://www.wiwoinc.com" target="_self">WIWO Inc</a>. </div>
            </div>
        </footer>
    </body>
</html>

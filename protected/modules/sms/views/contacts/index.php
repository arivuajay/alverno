                    	...
                    	<div style="padding-left:20px;" class="sms-block">
                            ...
                            <div style="position:relative;">
                                <div class="contrht_bttns" style="right:9px;">
                                    <ul>
                                        <li>
                                            <?php echo CHtml::link('<span>'.Yii::t('app', 'Create new contact').'</span>', array('create'));?>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <ul>
                            <li>
                            	<a href="javascript:void(0);" id="add_contacts_to_groups"><?php echo Yii::t('app', 'Add to groups');?></a></li>
                               <li> <?php
                                if(isset($_GET['group']) and $_GET['group']!=""){		//for group contacts only
								?>
                                <a href="javascript:void(0);" id="remove_contacts_from_group"><?php echo Yii::t('app', 'Remove from group');?></a>
                                <?php
								}
								?>
                                </li>
                               <li> <a href="javascript:void(0);" id="delete_contacts"><?php echo Yii::t('app', 'Delete');?></a></li>
                               </ul>

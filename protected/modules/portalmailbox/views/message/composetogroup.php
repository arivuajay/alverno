...
'enableAjaxValidation'=>true,
	...
	<div class="formCon" style="margin:10px; padding:10px; width:710px;">	
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><?php echo '<strong>'.CHtml::activeLabelEx($conv,Yii::t('app','To')).'</strong>'; ?></td>
    <td>
                <?php
...
?>
        ...
        <?php echo $form->dropDownList($conv,'to',CHtml::listData($data,'name','name'),array('id'=>'messagegroup-to','prompt'=>'select'));?> 
...
?></td>
  ...
  <tr>
    <td><?php echo '<strong>'.CHtml::activeLabelEx($conv,Yii::t('app','Subject'),array('class'=>'mailbox-label')).'</strong>'; ?></td>
  ...
  <tr>
    <td colspan="2">
		...
		<button class="btn btn-large message-btn-reply" onclick="no_recieve();" onclick="no_subject();"><?php echo Yii::t('message','Send Message');?></button>
		</div>
        </div>
	</div>

  ...
  <div class="mainpanel">
    <div class="headerbar"> <a class="menutoggle"><i class="fa fa-bars"></i></a>
      <?php 
                        ...
                        ?>
      <div class="searchform"><span class="col-md-4"><?php echo Yii::t('app','Welcome'); ?> <strong><?php echo ucfirst($student->last_name.' '.$student->first_name);?></strong> <?php echo Yii::t('app','in to your profile.'); ?></span></div>
      <div class="header-right">
        <ul class="headermenu">
          <li>
            <div class="btn-group"> <?php echo CHtml::link('<i class="glyphicon glyphicon-envelope"></i>',array('/portalmailbox'),array('class'=>'btn btn-default dropdown-toggle tp-icon')); ?> </div>
          </li>
          <li>
            <div class="btn-group">
              <?php 
              ...
              <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                ...
                <li> <?php echo CHtml::link('<i class="glyphicon glyphicon-cog"></i> '.Yii::t('app','Settings'),array('/user/profile'),array('class'=>'profile')); ?> </li>

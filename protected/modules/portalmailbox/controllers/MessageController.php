...
class MessageController extends RController
{
	...
	public function behaviors()
	{
		...
		return array(
			'ButtonAction'=>array(
				'class'=>'portalmailbox.behaviors.ButtonActionBehavior',
				'controller'=>$this,
				'module'=>$this->module,
	...
	public function actionTrash($ajax=null)
	{
		...
		Yii::app()->user->setFlash('notice', Yii::t('app',"Messages in the trash are deleted within {$period} days."));
	...
	public function actionNewgroup()
	{
		...
		{ 
		   ...
		   $users = AuthAssignment::model()->findAllByAttributes(array('itemname'=>$_POST['Mailbox']['to']));
			...
			{
				Yii::app()->user->setFlash('error', Yii::t('app',"Error sending message!"));
				Yii::app()->user->setFlash('success', Yii::t('app',"Check Sent Mail"));

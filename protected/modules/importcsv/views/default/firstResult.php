...
if($error==1) {
    ...
    echo("<span class='importCsvError'>".Yii::t('app', 'Error').": ".Yii::t('app', 'Unable to upload file')."</span>");
}
elseif ($error==2) {

    // second error: Download file is not a .csv

    echo("<span class='importCsvError'>".Yii::t('app', 'Error').": ".Yii::t('app', 'Upload file is not a .csv')."</span>");
}
elseif ($error==0) {

    ...
    <tr>
        ...
        <td valign="top">
            <div class="cont_right ">
                                ...
                                <b><h2><?php echo Yii::t('fees','Instructions for importing Students and Teachers into your Application:'); ?></h2></b>
                                 ...
                                 <br />    
                                    1. <?php echo Yii::t('app','Prepare the CSV file that contains the Student or Teacher information you need to import').'<br />'.'&nbsp;&nbsp;&nbsp;&nbsp;('.Yii::t('app','Please take care of spelling errors and that the correct information is entered into the correct columns.').')<br />';?>
                                       <ul id="sublist">
                                        <li><?php echo Yii::t('app','a. Download or open the appropriate sample CSV file: ');?><?php echo CHtml::link('<span>'.Yii::t('app','Student Import').'</span>', array('default/download','id'=>'stdcsv')); ?>&nbsp; &nbsp;<?php echo Yii::t('app','and');?> &nbsp;  <?php echo CHtml::link('<span>'.Yii::t('app','Teacher Import').'</span>', array('default/download','id'=>'empcsv')); ?></li>
                                        <li><?php echo Yii::t('app','b. Now capture the information to be imported as indicated in the CSV file');?></li>
                                        <li><?php echo Yii::t('app','c. Save the file to your computer as a comma delimited CVS file - just follow the prompts as given by Excel.');?></li>
                                     </ul>
                ...
                <?php /*?><div class="blue-info">
                 <?php echo Yii::t('app','To Download a sample CSV file click here:');?> 
                <span style="border-right:1px solid #fff; padding-right:3px; margin-right:3px"><?php echo CHtml::link('<span>'.Yii::t('app','Teacher').'</span>', array('default/download','id'=>'empcsv')); ?></span>
                <span><?php echo CHtml::link('<span>'.Yii::t('app','Student').'</span>', array('default/download','id'=>'stdcsv')); ?></span>
                </div><?php */?>
                ...
                <div id="importCsvSteps">
                	<div class="inner_new_table" style="padding:0px; display:none" id="delimiters_log">
                     <strong style="display:none;"><?php echo Yii::t('app', 'File'); ?> :</strong> <span id="importCsvForFile" style="display:none;">&nbsp;</span>
                    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <th width="30%">  <strong><?php echo Yii::t('app', 'Fields Delimiter'); ?></strong> </th>
                            <th width="30%"> <strong><?php echo Yii::t('app', 'Text Delimiter'); ?></strong> </th>
                            <th> <strong><?php echo Yii::t('app', 'Model'); ?></strong> </th>
                          </tr>
                          <tr>
                        ...
                        <div class="formCon">
                            <div class="formConInner">
                            	<table width="90%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="30%"><strong><?php echo Yii::t('app', 'Fields Delimiter'); ?></strong> <span class="require">*</span><br/></td>
                                  ...
                                  <tr>
                                    <td><strong><?php echo Yii::t('app', 'Text Delimiter'); ?></strong></td>
                                  ...
                                  <tr>
                                    <td><strong><?php echo Yii::t('app', 'Model'); ?></strong> <span class="require">*</span><br/></td>
                                    <td> 

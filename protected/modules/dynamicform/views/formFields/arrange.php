                    ...
                    <div class="formCon">
                        <div class="formConInner">
                            ...
                            <?php $form=$this->beginWidget('CActiveForm', array(
                                ...
                                <table>
                                    <tr>
                                        <td width="100"><?php echo Yii::t('app', 'Tab');?></td>
                                        <td><?php echo CHtml::dropDownList('model', (isset($_GET['model']) and $_GET['model']!="")?$_GET['model']:'', FormFields::model()->itemAlias('tab_selection'), array('onchange'=>'js:this.form.submit();', 'prompt'=>Yii::t('app', 'Select a model')));?></td>
                                    </tr>
                                </table>
                            <?php $this->endWidget(); ?>
                        </div>

...
<table width="94%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td width="130"><?php echo $form->labelEx($model,'title'); ?></td>
        <td><?php echo $form->textField($model,'title',array('size'=>30,'maxlength'=>255)); ?>
            <?php echo $form->error($model,'title'); ?></td>  
         <td width="150" align="right"><?php echo $form->labelEx($model,'form_field_type'); ?></td>
    ...
    <tr>
        ...
        <td align="right"><?php echo $form->labelEx($model,'tab_sub_section'); ?></td>

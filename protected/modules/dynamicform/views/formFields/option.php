           ...
           ?>
            ...
            <?php
                ...
                echo CHtml::hiddenField("option_data[".$i."]",$data->id);   
                   ...
                   {
                   ?>
                       <a href="javascript:void(0);" title="<?php echo Yii::t("app", "Click to remove option");?>" class="remove_row fees-trash" data="<?php if(isset($data->id)){ echo $data->id; } ?>"  data-row="<?php echo $i;?>"><span class="fa fa-trash-o"></span></a>            					                       
                       <?php
                   }
                   $i= $i+1;
...
<div class="formConInner">
        ...
        <?php if($first!=0) 
        { ?>
       <a href="javascript:void(0);" title="<?php echo Yii::t("app", "Click to remove option");?>" class="remove_row fees-trash"  data-row="<?php echo $first;?>"><span class="fa fa-trash-o"></span></a>            					
        <?php 

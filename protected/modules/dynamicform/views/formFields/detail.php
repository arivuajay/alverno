...
$this->breadcrumbs=array(
	...
	Yii::t('app','Form Field')=>array('index'),
	Yii::t('app','View'),
);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <ul><li><?php echo CHtml::link('<span>'.Yii::t('app','Back').'</span>', array('list')); ?></li>
    <li><?php 
    if($model->is_dynamic==1)
    {
        echo CHtml::link('<span>'.Yii::t('app','Edit').'</span>', array('dynamic','id'=>$model->id)); 
    }
    else
    {
        echo CHtml::link('<span>'.Yii::t('app','Edit').'</span>', array('update','id'=>$model->id)); 
    }
        ?></li>
    </ul>    
    </div>   

<div class="se_panel">
        <div class="col-md-12 se_header">
			...
			?></div>
            <div class="col-sm-8 se_head"> <h2><?php echo Yii::t('app','Student Enrolment - Parent Information'); ?></h2></div>
        </div>
        <div class="row">            
            <div class="col-md-4">
                  <?php 
            ...
            <div class="col-md-8 ">
                ...
                <?php $this->renderPartial('_step2', array('model'=>$model, 'token'=>$token));?>                
            </div><!-- col-sm-6 -->

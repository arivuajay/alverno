...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td valign="top">
            ...
            <?php $form=$this->beginWidget('CActiveForm', array('id'=>'onlineRegSettings-form',
				...
				<div class="formConInner">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>                        	
                            ...
                            <td valign="bottom"><?php echo $student->getAttributeLabel('batch_id'); ?></td>
						...
						<tr>                        	
                            ...
                            <td valign="top" style="color: #8e6704;font-size: 13px;font-weight: bold;">
                                <?php echo $name;?>
                            </td>  

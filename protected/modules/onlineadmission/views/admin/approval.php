...
.online_status{  position: absolute;
    right: 169px;
    bottom: 23px;
	margin-top:0px;}	
            ...
            <div class="cont_right formWrapper">                        
                ...
                <div class="search_btnbx">
                	<div class="contrht_bttns">
						<ul>
                        <li>
							<li><?php echo CHtml::link('<span>'.Yii::t('app','Clear All Filters').'</span>', array('approval')); ?></li>
                            <li><?php echo CHtml::link('<span>'.Yii::t('app','Manage Waiting List').'</span>', array('WaitinglistStudents/list')); ?></li>
                         </ul>
                        ...
                        <div class="filterbxcntnt_inner" style="border-bottom:#ddd solid 1px;">
                            <ul>
                                ...
                                {  echo Yii::app()->getModule('students')->fieldLabel("Students", "batch_id");
                                    ...
                                    <div id="batch" style="display:none; color:#000; width:520px; height:33px; padding-left:10px; padding-top:0px; left:-200px" class="drop">
                  ...
                  <br />             
									...
									<div class="a_feed_innercntnt">
										<div class="a_feed_inner_arrow"></div>
											...
											<table class="reg_bx" width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <?php
															if(FormFields::model()->isVisible('phone1','Students','forOnlineRegistration')){ ?>
												<tr>
											...
											<div class="online_but">
												<ul class="tt-wrapper">
													<li>
													<?php
														//echo CHtml::link('<span>'.Yii::t('students','Approve').'</span>', array('approve','id'=>$student->id),array('class'=>'tt-approved','confirm'=>'Are you sure you want to approve this?')); 
													...
													<li>
                                                    	<?php echo CHtml::link('<span>'.Yii::t('app','Delete').'</span>', array('delete','id'=>$student->id),array('class'=>'tt-delete','confirm'=>Yii::t('app','Are you sure you want to delete this?'))); ?>
                                                    </li>
						...
						?>
                        	<div>
                                <div class="yellow_bx" style="background-image:none;width:600px;padding-bottom:45px;">
                                    ...
                                    <?php 
                                        echo Yii::t('app','No Online Applicants for Approval');
                                    ?>
                                    </div>
                   ...
                   <?php /*?> <?php
					$this->widget('application.extensions.yiinfinite-scroll.YiinfiniteScroller', array(
						'contentSelector' => '#a_feed_cntnr',
						'itemSelector' => 'div.individual_feed',
						//'navigationLinkText' => false,
						'loadingText' => 'Loading...',
						'donetext' => 'No more oniine applications to show..!',
						'pages' => $pages,
					));

...
<!--<div class="lsearch_bar">
        ...
        <?php	
			...
			$countof_student_pendinglist = Students::model()->findAllByAttributes(array('status'=>0,'is_completed'=>3,'academic_yr'=>$academic_yr->config_value,'is_online'=>1));							
			...
			'items'=>array(
					array('label'=>''.Yii::t('app','Students List').'<span>'.Yii::t('app','All Students Details').'</span>', 'url'=>array('/students/students/manage') ,'linkOptions'=>array('class'=>'vsd_ico'),
                                   'active'=> ((Yii::app()->controller->id=='students') && (in_array(Yii::app()->controller->action->id,array('manage')))) ? true : false
					    ),                               
					array('label'=>''.Yii::t('app','Create New Student').'<span>'.Yii::t('app','New Admission').'</span>',  'url'=>array('/students/students/create') ,'linkOptions'=>array('class'=>'sl_ico' ),'active'=> (Yii::app()->controller->action->id=='create'  or Yii::app()->controller->id=='studentPreviousDatas' or Yii::app()->controller->id=='studentAdditionalFields'), 'itemOptions'=>array('id'=>'menu_1') 
					       ),
						...
						array('label'=>''.Yii::t('app','List Guardians').'<span>'.Yii::t('app','All Guardians Details').'</span>', 'url'=>array('/students/guardians/admin'),'active'=> ((Yii::app()->controller->id=='guardians') && (in_array(Yii::app()->controller->action->id,array('update','view','admin','index'))) ? true : false),'linkOptions'=>array('id'=>'menu_2','class'=>'lbook_ico')),

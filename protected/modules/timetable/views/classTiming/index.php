                    ...
                    <div class="emp_tabwrapper">
                        ...
                        <div class="emp_cntntbx" style="padding-top:10px;">
                            ...
                            <div class="edit_bttns" style="width:110px; top:10px;">
                                <ul>
                                <li>
                                <?php echo CHtml::link('<span>'.Yii::t('app','Time Table').'</span>', array('/timetable/weekdays/timetable','id'=>$_REQUEST['id']),array('class'=>'addbttn last'));?>
                                </li>
                                </ul>
                            <div class="clear"></div>
                            ...
                            <div style="width:100%">
								...
								<div class="right" align="left">
									<?php echo CHtml::link(Yii::t('app','Create Class Timings'), array('/timetable/classTiming/create','id'=>$_REQUEST['id']),array('class'=>'cbut')) ?>
								</div>
								<?php
								}
								?>

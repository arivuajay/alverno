                ...
                <div class="emp_right_contner">
                    <div class="emp_tabwrapper">
                        ...
                        <div class="emp_cntntbx" style="padding-top:10px;">
                            ...
                            <div class="edit_bttns" style="width:122px; top:10px;">
                                <ul>
                                <li>
                                <?php echo CHtml::link('<span>'.Yii::t('app','Class Timings').'</span>', array('/timetable/classTiming','id'=>$_REQUEST['id']),array('class'=>'addbttn last'));?>
                                </li>
                                </ul>
                            <div class="clear"></div>

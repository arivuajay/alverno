											...
											?>
													...
													<div class="formConInner">
														<table style="text-align:center;">
															<tr>
                                                                ...
                                                                <td>
                                                                	<?php
																		$timing = ClassTimings::model()->findAll("batch_id=:x", array(':x'=>$_REQUEST['bid'])); // Display pdf button only if there is class timings.
																		if($timing!=NULL){
																			echo CHtml::link(Yii::t('app','Generate PDF'), array('Weekdays/pdf','id'=>$_REQUEST['bid']),array('class'=>'cbut','target'=>'_blank')); 
																		}
																	?>
                                                                </td>
															</tr>
                                                ...
                                                <table>
                                                	<tr>
                                                        <td>
                                                            <?php
                                                                $timing = ClassTimings::model()->findAllByAttributes(array('batch_id'=>$_REQUEST['bid'])); // Display pdf button only if there is class timings.
                                                                if($timing!=NULL){
                                                                    echo CHtml::link(Yii::t('app','Generate PDF'), array('Weekdays/fullpdf','id'=>$_REQUEST['bid'],'yid'=>$_REQUEST['yid'],'cid'=>$_REQUEST['cid'],'mode'=>$_REQUEST['mode']),array('class'=>'cbut','target'=>'_blank')); 
                                                                }
                                                            ?>
                                                        </td>
                                                     </tr>
											...
											?>
                                                ...
                                                <table>
                                                	<tr>
                                                        <td>
                                                            <?php
                                                                $timing = ClassTimings::model()->findAll("batch_id=:x", array(':x'=>$batch->id)); // Display pdf button only if there is class timings.
                                                                if($timing!=NULL){
                                                                    echo CHtml::link(Yii::t('app','Generate PDF'), array('Weekdays/fullpdf','id'=>$batch->id,'yid'=>$_REQUEST['yid'],'cid'=>$_REQUEST['cid'],'mode'=>$_REQUEST['mode']),array('class'=>'cbut','target'=>'_blank')); 
                                                                }
                                                            ?>
                                                        </td>
                                                     </tr>
                                                	...
                                                	<tr>
                                                        <td>
                                                            <?php
                                                                $timing = ClassTimings::model()->findAll("batch_id=:x", array(':x'=>$_REQUEST['bid'])); // Display pdf button only if there is class timings.
                                                                if($timing!=NULL){
                                                                    echo CHtml::link(Yii::t('app','Generate PDF'), array('Weekdays/fullpdf','id'=>$_REQUEST['bid'],'yid'=>$_REQUEST['yid'],'cid'=>$_REQUEST['cid'],'mode'=>$_REQUEST['mode'],'day'=>$_REQUEST['day']),array('class'=>'cbut','target'=>'_blank')); 
                                                                }
                                                            ?>
                                                        </td>
                                                     </tr>

...
<table cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td style="width:500px; min-width:200px;">
            <?php echo Yii::t('app','Teacher Name').' : '.ucfirst($employee->first_name." ".$employee_1->last_name);?>
        </td>
            ...
            if($timetable!=NULL and $flag==1) // If class timing is set for the day and check acadamic year
             {
                ...
                foreach($timetable as $timetable_1)
                 {
                    ...
                    echo '<td style="text-align:center;" width="200">'.$class_timing->start_time.'-'.$class_timing->end_time.'</td>';                           
              ...
              {
                   echo '<tr>';
                   echo'<td colspan="4" width="100%">' .'<i>'.Yii::t('app','No Timetable is set for this Teacher!').'</i>'.'</td>';                            
                   echo '</tr>';
              }
            }

                                        ...
                                        <tr>
                                          ...
                                          <tr id="employee_dropdown"  >
                                            ...
                                            <td>
												...
												{
													$employee_names = CHtml::listData(Employees::model()->findAllByAttributes(array('employee_department_id'=>$_REQUEST['department_id'],'is_deleted'=>0),array('order'=>'id DESC')),'id','first_name'); 
                                         ...
                                         <td style="width:200px;"><strong><?php echo Yii::t('app','Select Day');?></strong></td>                                            <td>&nbsp;</td>
                                          <td>
											   ...
											   if($_REQUEST['day_id'] != '0' and $_REQUEST['day_id'] != NULL)
                                                ...
                                                echo CHtml::dropDownList('day_id','',array('1'=>'Sunday','2'=>'Monday','3'=>'Tuesday','4'=>'Wednesday','5'=>'Thursday','6'=>'Friday','7'=>'Saturday'),array('prompt'=>Yii::t('app','Select day'),'style'=>'width:190px;','onchange'=>'getday()','id'=>'day_id','options'=>array($_REQUEST['day_id']=>array('selected'=>true))));	
						...
						<table style="text-align:center;,bgcol">
							<tr>
								<td style="width:auto; min-width:200px;">
									<?php echo Yii::t('app','Name').' : '.ucfirst($employee_1->first_name." ".$employee_1->last_name);?>
											</td>
											<td width="20px">&nbsp&nbsp;
                                             <td width="20px">&nbsp;</td>

<div align="left" id="othleft-sidebar">
    ...
    <ul>
		...
		?>
            ...
            ?>
                <li class="list_active">
                    <?php echo CHtml::link( Yii::t('app','View Timetable').'<span>'. Yii::t('app','View').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").' '.Yii::t('app','wise Timetable').'</span>',array('/timetable/weekdays/timetable','id'=>$_REQUEST['id'],'type'=>'view'),array('class'=>'vt_ico'));
                    ?>
                </li>
            <?php 
			}
			...
			?>
                <li>
                    <?php echo CHtml::link( Yii::t('app','View Timetable').'<span>'. Yii::t('app','View').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").' '.Yii::t('app','wise Timetable').'</span>',array('/timetable/weekdays/timetable','id'=>$_REQUEST['id'],'type'=>'view'),array('class'=>'vt_ico'));?>
                </li>
			<?php
            }?>
		...
		?>
            <li>
            	<?php echo CHtml::ajaxLink( Yii::t('app','View Timetable').'<span>'. Yii::t('app','View').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").' '.Yii::t('app','wise Timetable').'</span>',array('/site/explorer','widget'=>'2','rurl'=>'timetable/weekdays/timetable'),array('update'=>'#explorer_handler'),array('id'=>'explorer_timetable','class'=>'vt_ico')); ?>
            </li>
        <?php 
		}
		?>
         ...
         <?php 
            if(Yii::app()->controller->action->id=='index' and Yii::app()->controller->id=='teachersTimetable')
            {
            ?>
                <li class="list_active">
                    <?php echo CHtml::link( Yii::t('app','View Teachers Timetable').'<span>'. Yii::t('app','View Teacher Wise Timetable').'</span>',array('/timetable/teachersTimetable/index'),array('class'=>'vft_ico'));
                    ?>
                </li>
            <?php 
			}
		...
		?>
            ...
            ?>
                <li class="list_active">
                    <?php echo CHtml::link( Yii::t('app','Set Timetable').'<span>'. Yii::t('app','Timetable For The').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").'</span>',array('/timetable/weekdays/timetable','id'=>$_REQUEST['id']),array('class'=>'set_t_ico'));
                ?>
                </li>
            <?php 
            }
            ...
            ?>
                <li class="list_active">
                    <?php echo CHtml::link( Yii::t('app','Set Weekdays').'<span>'. Yii::t('app','Weekdays For The').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").'</span>',array('/timetable/weekdays','id'=>$_REQUEST['id']),array('class'=>'set_w_ico'));
                ?>
                </li>
            <?php 
            }
            ...
            ?>
                <li class="list_active">
                <?php echo CHtml::link( Yii::t('app','Set Class Timing').'<span>'. Yii::t('app','Class Timing For The').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").'</span>',array('/timetable/classTiming','id'=>$_REQUEST['id']),array('class'=>'set_ct_ico'));
                ?>
                </li>

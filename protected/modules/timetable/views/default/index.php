   ...
   <?php $this->renderPartial('/default/left_side'); ?>
        ...
        <div class="cont_right formWrapper">
            ...
            <div class="status_box">
                  ...
                  <?php echo CHtml::ajaxLink(Yii::t('app','Select').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id"),array('/site/explorer','widget'=>'2','rurl'=>'timetable/weekdays/timetable'),array('update'=>'#explorer_handler'),array('id'=>'explorer_change','class'=>'sb_but')); ?>

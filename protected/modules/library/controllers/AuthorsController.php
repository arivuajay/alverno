...
class AuthorsController extends RController
{
	/**
  ...
  private function registerAssets(){
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('ajax_create','ajax_update','authordetails'),
				'users'=>array('@'),
			),
	...
	protected function performAjaxValidation($model)
	{
        ...
        $this->renderPartial('view',array('model'=>$model),false, true);
             ...
             if(isset($_POST['update_id']))$model= $this->loadModel($_POST['update_id']);else $model=new Author;
  ...
  public function actionAjax_Create(){
	  ...
	  public function actionAuthordetails()
	{
		...
		{				
			...
			{
				$this->render('stud_authordetails',array('model'=>$model));//if the current role is student,it render stud_authordetails.php page else it take authordetails.php page
			}
			else
			{
				$this->render('authordetails',array('model'=>$model));
			}
		}

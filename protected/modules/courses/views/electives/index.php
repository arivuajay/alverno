                            ...
                            <div class="emp_cntntbx" style="padding-top:10px;">
                                <div>
                                    <div> 
                                        ...
                                        <div class="edit_bttns" style="max-width:460px; width:auto; top:5px; right:-9px;">
                                        	<ul>
												<?php
                                                ...
                                                <li>
                                                    <?php echo CHtml::link(Yii::t('app','Create Elective Groups'), array('#'),array('id'=>'add_electivegroups','class'=>'cbut'));?>                 
                                                </li>
                                                <li>
                                                ...
                                                ?>
                                                <li>
                                                	<?php echo CHtml::link(Yii::t('app','Elective Groups'), array('/courses/electiveGroups','id'=>$_REQUEST['id']),array('class'=>'cbut'));?>      
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        $del_con = Yii::t('app', 'Are you sure you want to delete this electives?');

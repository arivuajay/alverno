...
$this->breadcrumbs=array(
	Yii::t('examination','Exams')=>array('/courses'),
	$model->id,
);
...
$this->menu=array(
	...
	array('label'=>'Delete Exams', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this Subject?')),

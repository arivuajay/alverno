                                    ...
                                    <div> 
                                        ...
                                        <div class="edit_bttns" style="max-width:460px; width:auto; top:5px; right:-9px;">
                                        	<ul>
                                                ...
                                                ?>
                                                <li>
                                                     <?php echo CHtml::link(Yii::t('app','Create Elective Groups'), array('#'),array('id'=>'add_electives','class'=>'cbut'));?>     
                                                </li>
                                                <?php
                                                }
                                                ?>
                                                <li>
                                                	<?php echo CHtml::link(Yii::t('app','Electives'), array('/courses/electives','id'=>$_REQUEST['id']),array('class'=>'cbut'));?>
                                                </li>
											</ul>
										</div>
                                        ...
                                        $del_con = Yii::t('app', 'Are you sure you want to delete this elective group?');

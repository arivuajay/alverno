 ...
 * @ver 1.3
 -->
<div id="elective-groups_form_con" class="client-val-form" style="width:350px">
...
<div class="row">
            ...
            <?php echo $form->textField($model,'code',array('size'=>60,'maxlength'=>15)); 
    ...
    <div class="row">
            ...
            <?php echo $form->textField($model,'max_weekly_classes',array('size'=>60,'maxlength'=>15)); 

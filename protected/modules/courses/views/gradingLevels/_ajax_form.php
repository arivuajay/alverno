...
<div id="grading-levels_form_con" class="client-val-form">
    ...
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header"><?php echo Yii::t('app','Update Grading Level : ').$model->name;?> </h3>
       <?php   endif;  ?>
...
<?php   $formId='grading-levels-form';
   ...
   ($model->isNewRecord)?CController::createUrl('gradingLevels/ajax_create')
    ...
    <div class="row">
        ...
        <div class="row">
            <?php echo $form->labelEx($model,'min_score',array('style'=>'color:#000000')); ?>

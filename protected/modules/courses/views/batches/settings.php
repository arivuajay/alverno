    ...
    <div class="clear"></div>
    	...
    	<div class="setbx_bot">
    		<ul>
                ...
                <?php echo CHtml::link(Yii::t('app','New Examination').'<span>'.Yii::t('app','New Examination').'</span>', array('/courses/exam','id'=>$_REQUEST['id']),
				...
				<?php echo CHtml::link(Yii::t('app','New Grading Level').'<span>'.Yii::t('app','New Grading Levels').'</span>', 
											array('/courses/gradingLevels','id'=>$_REQUEST['id']),array('class'=>''));?></li>
    			<li>
				...
				<?php echo CHtml::link(Yii::t('app','Set Default Grading Levels').'<span>'.Yii::t('app','Set Default Grading Levels').'</span>',
				 							array('/courses/gradingLevels/default','id'=>$_REQUEST['id']),array('class'=>'','confirm'=>Yii::t('app','Are You Sure? All custom settings will be deleted.')));?></li>
               <?php /*?> <li>

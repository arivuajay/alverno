															...
															echo '<tr>';
                                                                ...
                                                                <td >
                                                                    <div style="position:absolute;">
                                                                        <div  id="<?php echo $i; ?>" class="act_but">
																			<?php echo Yii::t('app','Actions');?>
																		</div>
                                                                        <div class="act_drop" id="<?php echo $i.'x'; ?>">
                                                                            <div class="but_bg_outer"></div><div class="but_bg">
                                                                        ...
                                                                        <ul>
																		   ...
																		   echo CHtml::ajaxLink(Yii::t('app','Approve').'<span>'.Yii::t('app','Approve the student').'</span>', 
																		   $this->createUrl('/onlineadmission/admin/approve'),
																		   array('onclick'=>'$("#jobDialog'.$posts_1->id.'").dialog("open"); return false;','update'=>'#jobDialog123'.$posts_1->id,'type' =>'GET','data'=>array('id' =>$posts_1->id,'bid'=>$_REQUEST['id']),),
																		   array('id'=>'showJobDialog'.$posts_1->id,'class'=>'tt-approved'));
														 						?>
                                                                            </li>
                                                                            <?php
																			}
                                                                            ...
                                                                            <li class="delete">
																				<?php echo CHtml::link(Yii::t('app','Delete').'<span>'.Yii::t('app','Delete from waiting list').'</span>', array('/onlineadmission/waitinglistStudents/delete', 'id'=>$posts_1->id,'batch_id'=>$_REQUEST['id'],'from'=>'course'),array('confirm' => Yii::t('app','Are you sure you want to delete this student from waiting list?'))) ?>
																			</li>

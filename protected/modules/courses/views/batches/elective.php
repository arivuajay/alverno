                            ...
                            <div class="emp_right_contner">
                                <div class="emp_tabwrapper">
                                    ...
                                    <div class="formCon" style="margin-bottom:10px; position:relative;margin-top:10px;">
                                        ...
                                        <?php /*?><div class="edit_bttns" style="top:15px; right:20px">
                                            <ul>
                                                <li> 
                                                <?php echo CHtml::ajaxLink('<span>'.Yii::t('app','Add New Batch').'</span>',$this->createUrl('batches/Addnew'),array('onclick'=>'$("#jobDialog").dialog("open"); return false;','update'=>'#jobDialog','type' =>'GET','data' => array( 'val1' =>$batch->course_id ),'dataType' => 'text'),array('id'=>'showJobDialog1','class'=>'addbttn last')); ?>
                                                </li>
                                            </ul>
                                            <div class="clear"></div>
                                        </div> <!-- END div class="edit_bttns" --><?php */?>

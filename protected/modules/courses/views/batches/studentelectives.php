                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                        ...
                                        foreach($posts as $posts_1)
                                        {
                                               ...
                                               if(FormFields::model()->isVisible("fullname", "Students", "forStudentProfile"))
                                            {
												...
												{
												?>
                                                <td><?php echo CHtml::link(Yii::t('app','Remove'),array('removeelective','eid'=>$posts_1->id,'id'=>$_REQUEST['id']),array('confirm'=>Yii::t('app','Are you sure you want to remove this student ?')));?></td>
                                                <?php
												}
												?>

...
if(isset($_REQUEST['id']))
{
	...
	<div class="c_batch_tbar">
        ...
        ?>
            ...
            echo CHtml::ajaxLink(Yii::t('app','Change').' '. Yii::app()->getModule('students')->fieldLabel("Students", "batch_id"),array('/site/explorer','widget'=>'2','rurl'=>$rurl[0]),array('update'=>'#explorer_handler'),array('id'=>'explorer_change','class'=>'sb_but','style'=>'top:-40px; right:40px;')); 
            ?>
        
        <?php 
        }else
        {
        	echo CHtml::ajaxLink(Yii::t('app','Change').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id"),array('/site/explorer','widget'=>'2','rurl'=>'courses/batches/batchstudents'),array('update'=>'#explorer_handler'),array('id'=>'explorer_change','class'=>'sb_but','style'=>'top:-40px; right:40px;'));
        }
		?>
        
        <?php echo CHtml::link('<span>'.Yii::t('app','close').'</span>',array('/courses'),array('class'=>'sb_but_close','style'=>'top:-40px; right:0px;'));?>
        
        <!-- Course - Batch - Class Teacher Name -->
        <div class="cb_left">
            <ul>
                <li><strong><?php echo Yii::t('app','Course').' / '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").' : '; ?></strong> <?php echo $coursename; ?> / <?php echo $batchname; ?></li>
        ...
        <div class="cb_right">
            <div class="status_bx">
                ...
                <ul>
                   ...
                   <li><span><?php echo count(TimetableEntries::model()->findAll(array('condition'=>'batch_id=:x', 'group'=>'employee_id','params'=>array(':x'=>$_REQUEST['id'])))); ?></span>
                            <?php echo Yii::t('app','Teachers');?>
                   </li>
                </ul>
                <div class="clear"></div>
            </div>
        ...
        <div style="position:absolute; top:27px; right:100px; ">
            <div id="tabdrop" class="act_but"><?php echo Yii::t('app','Actions'); ?></div>
            <div class="act_drop" id="tabdropx">
				...
				?>
					<li class="addstud"><?php echo CHtml::link(Yii::t('app','Add Student').'<span>'.Yii::t('app','for add new student').'</span>', array('/students/students/create','bid'=>$_REQUEST['id'])) ?></li><?php } ?> 
                ...
                <li class="mark"><?php echo CHtml::link(Yii::t('app','Add Elective').'<span>'.Yii::t('app','for add new subjects').'</span>', array('/courses/batches/elective','id'=>$_REQUEST['id'])) ?></li>
                <?php
				}
				?>
                <?php
	...
	if($week==NULL)
	{
		...
		$weeklink=CHtml::link(Yii::t('app','Define Now'), array('/courses/weekdays','id'=>$_REQUEST['id']));
		$allgreen=0;
	}
	else
	{
	...
	if($timing==NULL)
	{
		$timingnot='<div class="cbi_red">'.Yii::t('app','No class timings defined').'</div>';
		$ttabnot='<div class="cbi_gray">'.Yii::t('app','Timetable not created').'</div>';
		$timinglink=CHtml::link(Yii::t('app','Define Now'), array('/courses/classTiming/create','id'=>$_REQUEST['id']));
		$ttablink='';
		$allgreen=0;
	}
	else
	{
		$timingnot='<div class="cbi_green">'.Yii::t('app','Class Timings Defined').'</div>';
		$timinglink='';
	
		$ttab=TimetableEntries::model()->findByAttributes(array('batch_id'=>$batch->id));
		if($ttab==NULL)
		{
			$ttabnot='<div class="cbi_red">'.Yii::t('app','Timetable not created').'</div>';
			$ttablink=CHtml::link(Yii::t('app','Create Now'), array('/courses/weekdays/timetable','id'=>$_REQUEST['id']));
			$allgreen=0;
		}
		else
		{
			$ttabnot='<div class="cbi_green">'.Yii::t('app','Timetable Created').'</div>';
			$ttablink='';
		}
	}
	...
	?>
        <div class="emp_tab_nav">
            <ul style="width:940px;">
                ...
                {
                    echo CHtml::link(Yii::t('app','Students'), array('/courses/batches/batchstudents','id'=>$_REQUEST['id']),array('class'=>'active'));
                }
                else
                {
                	echo CHtml::link(Yii::t('app','Students'), array('/courses/batches/batchstudents','id'=>$_REQUEST['id']));
                }
                ?>
                ...
                {
                	echo CHtml::link(Yii::t('app','Subjects'), array('/courses/subject','id'=>$_REQUEST['id']),array('class'=>'active'));
                }
                else
                {
                	echo CHtml::link(Yii::t('app','Subjects'), array('/courses/subject','id'=>$_REQUEST['id']));
                }
                ?>
                ...
                {
                	echo CHtml::link(Yii::t('app','Timetable'), array('/courses/weekdays/timetable','id'=>$_REQUEST['id']),array('class'=>'active'));
                }
                else
                {
                	echo CHtml::link(Yii::t('app','Timetable'), array('/courses/weekdays/timetable','id'=>$_REQUEST['id']));
                }
                ?>
				...
				if($model->config_value == 1){
					...
					{
						echo CHtml::link(Yii::t('app','Attendances'), array('/courses/studentAttentance','id'=>$_REQUEST['id']),array('class'=>'active'));
					}
					else
					{
						echo CHtml::link(Yii::t('app','Attendances'), array('/courses/studentAttentance','id'=>$_REQUEST['id']));
						
					}
				}else{
					if(Yii::app()->controller->id=='subjectAttendance' or Yii::app()->controller->action->id=='courseAttendance')
					{
						echo CHtml::link(Yii::t('app','Attendances'), array('/attendance/subjectAttendance/courseAttendance','id'=>$_REQUEST['id']),array('class'=>'active'));
					}
					else
					{
						echo CHtml::link(Yii::t('app','Attendances'), array('/attendance/subjectAttendance/courseAttendance','id'=>$_REQUEST['id']));
					}
                ...
                {
                	echo CHtml::link(Yii::t('app','Assessments'), array('/courses/exam','id'=>$_REQUEST['id']),array('class'=>'active'));
                }
                else
                {
                	echo CHtml::link(Yii::t('app','Assessments'), array('/courses/exam','id'=>$_REQUEST['id']));
                }
                ?>
                ...
                {
                	echo CHtml::link(Yii::t('app','Electives'), array('/courses/batches/studentelectives','id'=>$_REQUEST['id']),array('class'=>'active'));
                }
                else
                {
                	echo CHtml::link(Yii::t('app','Electives'), array('/courses/batches/studentelectives','id'=>$_REQUEST['id']));
                }
                ?>
                ...
                {
                	echo CHtml::link(Yii::t('app','Waiting List Students'), array('/courses/batches/waitinglist','id'=>$_REQUEST['id']),array('class'=>'active'));
                }
                else
                {
                	echo CHtml::link(Yii::t('app','Waiting List Students'), array('/courses/batches/waitinglist','id'=>$_REQUEST['id']));
                }
                ?>
                ...
                {
                	echo CHtml::link(Yii::t('app','Settings'), array('/courses/batches/settings','id'=>$_REQUEST['id']),array('class'=>'active'));
                }
                else
                {
                	echo CHtml::link(Yii::t('app','Settings'), array('/courses/batches/settings','id'=>$_REQUEST['id']));
                }
                ?>
                </li>

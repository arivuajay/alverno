                        ...
                        <div class="emp_tabwrapper">
                            ...
                            <div class="emp_cntntbx" style="padding-top:40px;">
                                <div id="success_flash" align="center" style=" color:#F00; display:none;">
                                	<h4><?php echo Yii::t('app','Selected Exam Group Deleted Successfully!');?></h4>
                                </div>
                                <div class="c_subbutCon" align="right" style="width:100%">
                                    <div class="edit_bttns" style="width:auto; max-width:270px; top:10px; right:-10px;">
                                        <ul>
                                        	<?php
											...
											?>
                                                <li>
                                                <?php echo CHtml::link('<span>'.Yii::t('app','Create Exam').'</span>', array('#'),array('id'=>'add_exam-groups','class'=>'addbttn')) ?>
                                                </li>
                                            <?php
											}
											?>
                                            <li>
                                            <?php echo CHtml::link('<span>'.Yii::t('app','Grading Levels').'</span>', array('/courses/gradingLevels','id'=>$_REQUEST['id']),array('class'=>'addbttn last')) ?>
                                            </li>
                                        </ul>
                                        <div class="clear"></div>
									...
									'columns' => array(
										...
										*/
										...
										'buttons' => array(
																			...
																			'url'=>'Yii::app()->createUrl("/courses/exam/publishdate", array("exam_group_id"=>$data->id,"id"=>$_REQUEST["id"]))', // a PHP expression for generating the URL of the button
																			...
																			'url'=>'Yii::app()->createUrl("/courses/exam/publishresult", array("exam_group_id"=>$data->id,"id"=>$_REQUEST["id"]))', // a PHP expression for generating the URL of the button
										...
										//'$data->is_published ? template => {add} : template => {add},{pub}',
...
// DELETE
    ...
    $('.fan_del').each(function(index) {
        ...
        dialogs[id] =
                        ...
                        .html('<p><br><?php echo addslashes($del_con); ?><br></p>')
                       .dialog(
                        {
                            autoOpen: false,

...
<div id="exam-groups_form_con" class="client-val-form" >
    <?php if ($model->isNewRecord) : ?>    <h3 id="create_header"><?php echo Yii::t('app','Create New Exam Group');?></h3>
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header"><?php echo Yii::t('app','Update Exam Group : ').$model->name;?></h3>
    <?php   endif;  ?>
    <?php      $val_error_msg = Yii::t('app','Error ! Exam Group was not saved.');
    ...
    <?php if($model->batch_id==NULL)
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td> <?php echo $form->dropDownList($model,'exam_type',array('Marks'=>Yii::t('app','Marks'),'Grades'=>Yii::t('app','Grades'),'Marks And Grades'=>Yii::t('app','Marks And Grades'))); ?>

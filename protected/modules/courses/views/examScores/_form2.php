...
<?php 
    ...
    <ul>
    <li>
    <?php echo CHtml::link('<span>'.Yii::t('app','Clear All Scores').'</span>', array('examScores/deleteall','id'=>$_REQUEST['id'],'examid'=>$_REQUEST['examid']),array('class'=>'addbttn last','confirm'=>Yii::t('app','Are You Sure? All Scores will be deleted.')));?>
    </li>

<div class="formCon" style="width:60%">
    <div class="formConInner" >
        ...
        <table width="50%">
        	<tr>
            	<td><strong>Examination: </strong><?php echo ucfirst($exam_group->name); ?></td>
                <td><strong>Subject: </strong><?php echo ucfirst($exam->name); ?></td>
			</tr>
        </table>
    </div>
</div>
...
<?php $form=$this->beginWidget('CActiveForm', array(
  ...
  <tr>
    <td><?php echo $form->labelEx($model,Yii::t('app','start_time')); ?></td>
    <td>
		<?php  
    ...
    <td><?php echo $form->labelEx($model,Yii::t('app','end_time')); ?></td>
    <td>
    	<?php
			$this->widget('application.extensions.timepicker.timepicker', array(
				'model' => $model,

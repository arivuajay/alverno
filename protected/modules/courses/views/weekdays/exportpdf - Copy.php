...
hr{ border-bottom:1px solid #ccc; border-top:0px solid #fff;}
	...
	?> 
        ...
        <!-- End Header --> 
      <br />
    <div style="text-align:center; display:block;"><?php echo Yii::t('app','CLASS TIME TABLE');?></div><br />
    <!-- Course details -->
    
        <table style="font-size:14px; border:#C5CED9 1px; width:700px; padding:10px 10px; background:#DCE6F1;">
            ...
            <tr>
                ...
                <td style="width:400px;"><?php echo $course_name->course_name; ?></td>
            ...
            <tr>
                ...
                <td>
   				...
   				<?php
				$total_students = BatchStudents::model()->countByAttributes(array('batch_id'=>$_REQUEST['id'],'status'=>1));
				?>
                <td><?php echo Yii::t('app','Total students'); ?></td>
                <td>:</td>
                <td width="350"><?php echo $total_students; ?></td>
            </tr>
	...
	?>
		...
		<table  align="left" width="600" id="table" cellspacing="0" cellpadding="0" class="timetable" >
			<tr>
			  <td width="10px" style="background:#DCE6F1;">&nbsp;</td>
			  <?php 
					foreach($timing as $timing_1)
					{
						//echo $timing_1->start_time.'<br>';  ?>
					<?php echo '<td style="font-size:11px;background:#DCE6F1;">'.$timing_1->start_time .' - <br>'.$timing_1->end_time.'</td>';?>
				<?php 	}
			   ?>
			</tr> <!-- timetable_tr -->

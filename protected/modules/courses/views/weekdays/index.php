                        ...
                        <div class="emp_tabwrapper">
                            ...
                            <div class="emp_cntntbx" style="padding-top:10px;">
                                <div class="c_subbutCon" align="right" >
                                    <div class="edit_bttns" style="width:110px; top:15px; z-index:1000">
                                        <ul>
                                            <li>
                                            <?php echo CHtml::link('<span>'.Yii::t('app','Time Table').'</span>', array('weekdays/timetable','id'=>$_REQUEST['id']),array('class'=>'addbttn last'));?>
                                            </li>
                                        </ul>
                                        <div class="clear"></div>
											...
											<div>
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="85%" align="left"><?php echo Yii::t('app','Sunday');?></td>
                                                        <td width="11%"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left"><?php echo Yii::t('app','Monday');?></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left"><?php echo Yii::t('app','Tuesday');?></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left"><?php echo Yii::t('app','Wednesday');?></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left"><?php echo Yii::t('app','Thursday');?></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left"><?php echo Yii::t('app','Friday');?></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left"><?php echo Yii::t('app','Saturday');?></td>
                                                        <td></td>
                                                    </tr>
                                                </table>
											</div>

...
<h1><?php echo Yii::t('app','Create Exam Groups'); ?></h1>
...
echo '<strong>'.Yii::t('app','Select Course').'</strong>';
...
echo CHtml::dropDownList('cid','',$data,array('onchange'=>'course()','id'=>'coursedrop','empty'=>Yii::t('app','Select Course'),'options'=>array($sel=>array('selected'=>true)))); 
echo '<br>';

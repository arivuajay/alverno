...
<div id="class-timings_form_con" class="client-val-form">
    ...
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header"><?php echo Yii::t('app','Update Class Timing');?></h3>
    <?php   endif;  ?>
    <?php      $val_error_msg = Yii::t('app','Error ! The class timing was not saved.');
    $val_success_message = ($model->isNewRecord) ?
            Yii::t('app','Class Timing was set successfuly.') :
            Yii::t('app','Class Timing was updated successfuly.');
  ?>

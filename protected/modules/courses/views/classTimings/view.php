...
$this->menu=array(
	...
	array('label'=>'Delete ClassTimings', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this'.' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").' '.'?')),

			...
			function t($message, $category = 'cms', $params = array(), $source = null, $language = null) 
{
    return $message;
			...
			'items'=>array(
					...
					array('label'=>Yii::t('app','List').' '.Yii::app()->getModule("students")->labelCourseBatch().'<span>'.Yii::t('app','Current Courses and').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").' '.Yii::t('app','Details').'</span>', 'url'=>array('courses/managecourse'), 

...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td valign="top">
          ...
          <div class="formCon">
     				<div class="formConInner" style="width:681px">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="s_search">
                <tr>
                    <td>&nbsp;</td>
                    <td style="width:90px;"><strong><?php echo Yii::t('app','Select Course');?></strong></td>
                    <td>&nbsp;</td>
                    <td>
                    <?php
					...
					?>
                    <div align="left" style="padding-right:15px !important">
                <?php
				if(($year == $current_academic_yr->config_value) or ($year != $current_academic_yr->config_value and $is_create->settings_value!=0))
				{
					echo CHtml::ajaxLink(Yii::t('app','Add Subject'),$this->createUrl('/courses/subjectsCommonPool/Addnew'),
										...
										array('id'=>'showJobDialog2'.$_GET['course'],'class'=>'sb_but'));
				}
				?>
             <br />
				</div>
								...
								<tbody>
									...
									if(count($subjects)){
										...
										if(($year == $current_academic_yr->config_value) or ($year != $current_academic_yr->config_value and $is_edit->settings_value!=0))
										{
											...
											'update'=>'#jobDialog123','type' =>'GET','data' => array( 'sub_id' =>$subject->id,'course_id'=>$subject->course_id),'dataType' => 'text'),array('id'=>'showJobDialogsub'.$subject->id,'class'=>'add')); 
										}
									...
									?>
                                    <tr>
                                    <td colspan="5" align="center"><strong><?php echo Yii::t('app','Nothing found!!');?></strong></td>
                                    </tr>
                                    <?php

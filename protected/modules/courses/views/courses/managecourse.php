					...
					?>
						...
						<div class="mcbrow" id="jobDialog1">
							<ul>
								...
								?>
								<li class="col3">
									<?php echo CHtml::link(Yii::t('app','Delete'),array('deactivate','id'=>$posts_1->id),
																array('confirm'=>Yii::t('app','Are you sure you want to delete this course ?').
																Yii::t('app','Note: All details (students, timetable, fees, exam) related to this').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").' '.Yii::t('app','will be deleted.'),'class'=>'delete'));?>
								</li>
                                <?php
								}else{
								?>
								...
								<li class="col4">
									<?php echo CHtml::ajaxLink(Yii::t('app','Add Subject'),$this->createUrl('subjectsCommonPool/Addnew'),
														...
														array('id'=>'showJobDialog2'.$posts_1->id,'class'=>'add')); ?>
								</li>
                                <li class="col4">
                            ...
                            <br />
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tbody>
										...
										<td align="center" width="22%"><?php echo Yii::t('app','Subject Code');?></td>
                                    ...
                                    ?>
                                            ...
                                            'update'=>'#jobDialogsub','type' =>'GET','data' => array( 'sub_id' =>$subject->id,'course_id'=>$subject->course_id ),'dataType' => 'text'),array('id'=>'showJobDialogsub'.$subject->id,'class'=>'add')); 
                                            }
                                            if(($year == $current_academic_yr->config_value) or ($year != $current_academic_yr->config_value and $is_delete->settings_value!=0))
                                            {
                                            echo ''.CHtml::ajaxLink(Yii::t('app','Delete'), $this->createUrl('subjectsCommonPool/remove'), array('success'=>'rowdeletesub('.$subject->id.')','type' =>'GET',
                                                                    'data' => array( 'sub_id' =>$subject->id ),'dataType' => 'text'),

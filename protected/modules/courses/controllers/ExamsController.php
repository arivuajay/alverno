	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Exams']))
		{
			...
			for($i=0;$i<$electivecount;$i++)
			{
				...
				if($_POST['ElectiveExams']['maximum_marks'][$i]!=NULL and $_POST['ElectiveExams']['minimum_marks'][$i]!=NULL and $_POST['ElectiveExams']['start_time'][$i]!=NULL and $_POST['ElectiveExams']['end_time'][$i]!=NULL)
				{	

        ...
        <div class="visible-xs hidden-sm hidden-md hidden-lg">   
            <div class="media userlogged">
                <?php
					...
					{
						echo '<img  src="images/portal/p-small-male_img.png" alt='.$teacher->first_name.'  class="media-object"  />'; 
					}
					elseif($teacher->gender=='F')
					{
						echo '<img  src="images/portal/p-small-female_img.png" alt='.$teacher->first_name.' class="media-object"  />';
					}
					?>

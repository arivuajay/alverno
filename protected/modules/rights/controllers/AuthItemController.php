...
class AuthItemController extends RController
{
	...
	*/
	...
	public function actionAssignRole()
	{
		...
		$model=new UserRoles;
		                    //Default
							$controller['default'] = array("Mailbox.Ajax","Mailbox.Message","Mailbox.News","Dashboard.Default","Dashboard.Index");
							//Home
  ...
  "Students.StudentAttentance","Students.StudentCategories","Students.StudentCategory","Students.StudentDocument","Students.StudentLeave","Students.StudentPreviousDatas","Students.Students","Students.LogCategory","Students.Logcomment","Onlineadmission.Admin","Onlineadmission.Default","Onlineadmission.Registration","Onlineadmission.WaitinglistStudents","Savedsearches");
							...
							//Fees
							$controller[8] = array("Fees.Create","Fees.Dashboard","Fees.Invoices","Fees.Subscriptions","Fees.View");
							//Report
							...
							//Transport
							$controller[12] = array("Transport.BusLog","Transport.Default","Transport.DriverDetails","Transport.FuelConsumption","Transport.RouteDetails","Transport.StopDetails","Transport.Transportation","Transport.VehicleDetails");
							//Library

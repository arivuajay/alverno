...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
        ...
        <?php echo $form->dropDownList($model,'employee_leave_type_id',CHtml::listData(EmployeeLeaveTypes::model()->findAll("status=:x",array(':x'=>1)), 'id', 'name'),array('empty'=>Yii::t('app','Select Type'),'ajax' => array(
								'type'=>'POST',
	...
	<div class="row halfday-con" id="halfday" style="display:none">
	...
	<div class="row buttons">
		...
		echo CHtml::ajaxSubmitButton(Yii::t('app','Save'),CHtml::normalizeUrl(array('EmployeeAttendances/Addnew','render'=>false)),array('dataType'=>'json','success'=>'js: function(data) {
					...
					{
						$("#td'."_".$day."_".$emp_id.'").text("");
						$("#jobDialog123'."_".$day."_".$emp_id.'").html("<span class=\"abs\"></span>","");
						$("#jobDialog'."_".$day."_".$emp_id.'").dialog("close");

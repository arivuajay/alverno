 ...
 <div class="edit_bttns" style="width:350px; top:30px; right:50px;">
            	<ul>
                <li>
 <?php  echo CHtml::ajaxLink('<span>'.Yii::t('app','Student Attendance').'</span>',array('/site/explorer','widget'=>'s_a','rurl'=>'attendance/studentAttentance'),array('update'=>'#explorer_handler'),array('id'=>'explorer_change','class'=>'addbttn','style'=>'right:120px;')); ?>
  </li>
  </ul>
  </div>
  ...
  ?>
            ...
            <?php echo CHtml::link('<span>'.Yii::t('app','close').'</span>',array('/attendance'),array('class'=>'sb_but_close','style'=>'right:25px;top:30px;'));?>

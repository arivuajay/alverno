      ...
      <tr>
		...
		<div style="padding:20px; position:relative;">
            ...
            <div class="edit_bttns" style="width:350px; top:30px; right:-15px;">
                ...
                <li>
           <?php  echo CHtml::ajaxLink('<span>'.Yii::t('app','Student Attendance').'</span>',array('/site/explorer','widget'=>'s_a','rurl'=>'attendance/studentAttentance'),array('update'=>'#explorer_handler'),array('id'=>'explorer_change_1','class'=>'addbttn')); ?>
           		</li> 
                <?php }else{ ?>
                <li>
           <?php  echo CHtml::ajaxLink('<span>'.Yii::t('app','Student Attendance').'</span>',array('/site/explorer','widget'=>'sub_att','rurl'=>'attendance/studentAttentance'),array('update'=>'#explorer_handler'),array('id'=>'explorer_change_2','class'=>'addbttn')); ?>
           		</li> 
                <?php } ?>
                 <li>
                 <?php echo CHtml::link('<span>'.Yii::t('app','Teacher Attendance').'</span>',array('/attendance/employeeAttendances'),array('class'=>'addbttn'));?>
                 </li>
                 </ul>
           </div> 

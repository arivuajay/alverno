...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="247" valign="top"><div class="emp_cont_left">
        <?php $this->renderPartial('individualleft');?>
      </div></td>
    ...
    <div class="searchbx_cntnt">
        ...
        <div class="edit_bttns last">
          <ul>
            <li> <?php echo CHtml::link('<span>'.Yii::t('app','Edit').'</span>', array('/students/students/update', 'id'=>$model->id),array('class'=>' edit ')); ?> </li>
            <li> <?php echo CHtml::link('<span>'.Yii::t('app','Students').'</span>', array('/students/students/manage'),array('class'=>'edit last'));?> </li>
          </ul>
        </div>
        <div class="clear"></div>
...
?>
	...
	?>
        ...
        {   
            echo CHtml::link('<div class="atnd_arow_l"><img src="images/atnd_arrow-l.png" width="7" border="0"  height="13" /></div>',
                    array('/attendance/subjectAttendance/individual','date'=>date('Y-m-d',strtotime($curr_date . "-1 days")),
                        'id'=>$_REQUEST['id'])); 
        }
 ...
 <span style="display:block; width:100%; height:40px; background:#F2F2F2"  title=""></span>
	...
	<?php } ?>
            ...
            <div class="ea_pdf" style="top:146px; right:16px; ">
			<?php
             
             if(isset($_REQUEST['date']) && ($_REQUEST['date'] != NULL)){
              	echo CHtml::link('<img src="images/pdf-but.png" border="0">', array('/attendance/subjectAttendance/individualPdf','date'=>$_REQUEST['date'],'id'=>$_REQUEST['id']),array('target'=>'_blank')); 
              }else{
                echo CHtml::link('<img src="images/pdf-but.png" border="0">', array('/attendance/subjectAttendance/individualPdf','date'=>date('Y-m-d'),'id'=>$_REQUEST['id']),array('target'=>'_blank')); 
              }

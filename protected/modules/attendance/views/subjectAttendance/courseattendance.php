...
$this->breadcrumbs=array(
	...
	Yii::t('app',$batch->name)=>array('/courses/batches/batchstudents','id'=>$batch->id),
...
<div style="background:#fff; min-height:800px;"> 
                    ...
                    <div style="padding:20px;">
                        ...
                        <div class="emp_right_contner">
                            <div class="emp_tabwrapper">
								<?php $this->renderPartial('application.modules.courses.views.batches.tab');?>
                                
                                <div class="clear"></div>
                                <div class="atnd_Con" style="overflow-x:scroll; width:958px; position:relative;">
	...
	?>
        ...
        {   
            echo CHtml::link('<div class="atnd_arow_l"><img src="images/atnd_arrow-l.png" width="7" border="0"  height="13" /></div>',
                    array('/attendance/subjectAttendance/courseAttendance','date'=>date('Y-m-d',strtotime($curr_date . "-1 days")),
                        'id'=>$batch->id)); 
        }
        ...
        ?>
                ...
                <tbody>
                    <tr>
                        <td class="td">
                            <div class="name"><?php echo Yii::t('app','Student Name'); ?></div>
                        </td>
                        ...
                        for($i=0;$i<$count_timing;$i++)
                        {
                            ...
                            if(count($set)==0)
                            {
                                ...
                                if($is_break==NULL)
                                    echo Yii::t('weekdays','Not Assigned');
 ...
 <span style="display:block; width:100%; height:40px; background:#F2F2F2"  title=""></span>
	...
	<?php } ?>
			  ...
			  <div class="ea_pdf" style="top:0px; right:0px; ">
									<?php
                                     
                                     if(isset($_REQUEST['date']) && ($_REQUEST['date'] != NULL)){
                                        echo CHtml::link(Yii::t('app', 'Generate PDF'), array('/attendance/subjectAttendance/courseAttendancePdf','date'=>$_REQUEST['date'],'id'=>$_REQUEST['id']),array('target'=>'_blank','class'=>'pdf_but')); 
                                      }else{
                                        echo CHtml::link(Yii::t('app', 'Generate PDF'), array('/attendance/subjectAttendance/courseAttendancePdf','date'=>date('Y-m-d'),'id'=>$_REQUEST['id']),array('target'=>'_blank','class'=>'pdf_but')); 
                                      }

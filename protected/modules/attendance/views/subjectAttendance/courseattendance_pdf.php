...
<?php
    ...
    <!-- Student details -->
        ...
        <table style="font-size:14px; background:#DCE6F1; padding:10px 10px;border:#C5CED9 1px solid;">
            ...
            <tr>
                ...
                <td style="width:150px;"><b><?php echo Yii::t('app','Course'); ?></b></td>
                ...
                <td width="150"><b><?php echo Yii::app()->getModule('students')->fieldLabel("Students", "batch_id"); ?></b></td>
                <td>:</td>
                <td width="350">
					<?php 
					if($batch->name!=NULL)
            ...
            <tr>
            	<td><b><?php echo Yii::t('app','Total Students'); ?></b></td>
                <td>:</td>
                <td>
					<?php 
					if($students!=NULL)
                ...
                <td>:</td>
                <td><?php if(isset($_REQUEST['date']) && $_REQUEST['date'] != NULL ) 
								echo date($date_format,strtotime($_REQUEST['date']));
							else
								echo date($date_format,strtotime(date('Y-m-d'))); 
					?></td>
            </tr>
   ...
   <!-- Attendance table -->
        ...
        <?php if(array_key_exists($curr_date, $holiday_arr)){ 
                ...
                <table border="0" align="center" width="600" id="table" cellspacing="2" class="attendance_table" bgcolor="#C5CED9">
                <tbody>
                    <tr>
                       <td width="40">
                        ...
                        {
                            echo ' <td class="td" width="40" bgcolor="#FFFFFF">
                        ...
                        for($i=0;$i<$count_timing;$i++)
                        {
                            ...
                            else
                            {
								...
								if($absent){
									...
									$label = "<span style='color:#ce0606;text-align:center;'><strong>X</strong></span>";
									echo $label;
									
								}
								else{
									if($curr_date < $today_date)	
										$label = '<div style="background-color:#093;width:10px;height:10px;display:block;text-align:center;"></div>';
									else

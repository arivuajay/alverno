...
<div class="form">
<span style="color:#F00"><?php echo '*'.Yii::t('app','Please select recipients (Student, Guardians, Teacher) for SMS / Email function.');?></span>
        ...
        <tbody>
            <tr class="pdtab-h">
                ...
                <td>
                    ...
                    <div style="float:left; padding-top:2px;padding-left:5px;"><?php echo Yii::t('app','Guardian 1');?></div>
				</td>
...
<!-- Fees -->            
            <tr>
                ...
                <td style="text-align:center;">
                	<?php 
					if($posts[7]->student=='1')
					{ 
						echo $form->checkBox($model,'student_fees',array('class'=>'student check_role','checked'=>'true'));
					}
					else
					{
						echo $form->checkBox($model,'student_fees',array('class'=>'student check_role')); 
					}
					?>
                	<?php echo $form->error($model,'student_fees'); ?>
				</td>
                <td style="text-align:center;">
                	<?php 
...
<!-- User Creation -->            
            <tr>
                ...
                <?php /*?><td style="text-align:center;">
                	<?php 
					if($posts[11]->sms_enabled=='1')
					{ 
						echo $form->checkBox($model,'sms_user',array('class'=>'sms check_sms','checked'=>'true'));
					}
					else
					{
						echo $form->checkBox($model,'sms_user',array('class'=>'sms check_sms')); 
					}
					?>
                	<?php echo $form->error($model,'sms_user'); ?>
				</td><?php */?>
                <td style="text-align:center;"><?php echo "-";?></td>
                <td style="text-align:center;">
                	<?php 
        		...
        		<td style="text-align:center;">
                	<?php 
					if($posts[11]->student=='1')
					{ 
						echo $form->checkBox($model,'student_user',array('class'=>'student check_role','checked'=>'true'));
					}
					else
					{
						echo $form->checkBox($model,'student_user',array('class'=>'student check_role')); 
					}
					?>
                	<?php echo $form->error($model,'student_user'); ?>
				</td>                 
                 <td style="text-align:center;">
                	<?php 
					if($posts[11]->parent_1=='1')
					{ 
						echo $form->checkBox($model,'parent_1_user',array('class'=>'parent_1 check_role','checked'=>'true'));
					}
					else
					{
						echo $form->checkBox($model,'parent_1_user',array('class'=>'parent_1 check_role')); 
					}
					?>
                	<?php echo $form->error($model,'parent_1_user'); ?>
				</td>                     
                <td style="text-align:center;">
                	<?php 
					if($posts[11]->employee=='1')
					{ 
						echo $form->checkBox($model,'employee_user',array('class'=>'employee check_role','checked'=>'true'));
					}
					else
					{
						echo $form->checkBox($model,'employee_user',array('class'=>'employee check_role')); 
					}
					?>
                	<?php echo $form->error($model,'employee_user'); ?>
				</td>            
            </tr>
<!-- Online admission -->            
    		<tr>
...
<!-- Public Holiday -->                             
               ...
               <td style="text-align:center;"><?php echo "-";?></td>
                <td style="text-align:center;">
                	<?php 
					if($posts[18]->student=='1')
					{ 
						echo $form->checkBox($model,'student_document',array('class'=>'student check_role','checked'=>'true'));
					}
					else
					{
						echo $form->checkBox($model,'student_document',array('class'=>'student check_role')); 
					}
					?>
                	<?php echo $form->error($model,'student_document'); ?>
				</td>
                <td style="text-align:center;">
                	<?php

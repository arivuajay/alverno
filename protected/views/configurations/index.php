...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="90%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <div style="width:700px;border-bottom: 1px solid #E2E2E2;">
    	...
    	<div class="setbx_con">
   			<div class="block_box">    
                ...
                <div class="setbx_top">
                <h1 class="headings"><?php  echo Yii::t('app','General Settings'); ?></h1>
                ...
                <div class="setbx_bot">
                    <ul>
                        ...
                        <?php echo CHtml::link(Yii::t('app','Backup / Restore').'<span>'.Yii::t('app','Complete Database Backup').'</span>', array('/backup'),array('class'=>'name-txt')) ?></li>
                        <?php 
						}
                        ...
                        <?php echo CHtml::link(Yii::t('app','Translation').'<span>'.Yii::t('app','Language Translation').'</span>', array('/translate/generate'),array('class'=>'name-txt')) ?></li>
                       ...
                       <li class="menu_box">
                        ...
                        <?php echo CHtml::link(Yii::t('app','Annual Holidays').'<span>'.Yii::t('app','Manage Annual Holidays').'</span>', array('/holidays'),array('class'=>'name-txt')) ?></li>
                        ...
                        <li class="menu_box">
                        <div class="set_icon"><i class="fa fa-tint"></i></div>
                        <?php echo CHtml::link(Yii::t('app','Portal Themes').'<span>'.Yii::t('app','Manage Portal Themes').'</span>', array('/portalThemes'),array('class'=>'name-txt')) ?>
                        </li>
                        
                        <li class="menu_box">
                        <div class="set_icon"><i class="fa fa-laptop"></i></div>
                        <?php echo CHtml::link(Yii::t('app','System Upgrade').'<span>'.Yii::t('app','Manage System Offline Schedule').'</span>', array('/offlineSettings'),array('class'=>'name-txt')) ?></li>
                        ...
                        <?php echo CHtml::link(Yii::t('app','Features').'<span>'.Yii::t('app','Manage Features').'</span>', array('/configurations/features'),array('class'=>'name-txt')) ?></li>
                        <?php 
						}
						?>
                        ...
                        <div class="set_icon"><i class="fa fa-calendar"></i></div>
                        <?php
                        echo CHtml::ajaxLink(Yii::t('app','Attendance Type').'<span>'.Yii::t('app','Manage Annual Type').'</span>',$this->createUrl('/attendanceSettings/changeType'),array(
                                            'type' =>'GET','data'=>array(),
                                            'onclick'=>'$("#changeType_dialog").dialog("open"); return false;',				
                                            'update'=>'#changeType_dialog_div',				
                                            ),array('id'=>'showJobDialog','class'=>'at_abs'));
                                            
                        ?>
                        </li>
                        <div  id="changeType_dialog_div"></div><?php */?>
    	...
    	<div class="setbx_bot">
   			<ul>
                ...
                <div class="set_icon"><i class="fa fa-keyboard-o"></i></div>
                	<?php echo CHtml::link(Yii::t('app','Online Registration Settings').'<span>'.Yii::t('app','Online Registration Settings').'</span>', array('/onlineRegisterSettings'),array('class'=>'name-txt')) ?>
                </li>
                <li class="menu_box">
            ...
            <div class="setbx_bot">
                <ul>
                   ...
                   <li class="menu_box">
                    ...
                    <?php echo CHtml::link(Yii::t('app','Common Class Timings').'<span>'.Yii::t('app','Create').' & '.Yii::t('app','Manage Institution Class Timings').'</span>', array('/commonClassTimings'),array('class'=>'name-txt')) ?></li>
                    <?php
					}
					if(ModuleAccess::model()->check('Courses'))
					{
                    ...
                    <li class="menu_box">
                    <div class="set_icon"><i class="fa fa-calendar"></i></div>
                    <?php echo CHtml::link(Yii::t('app','Default Weekdays').'<span>'.Yii::t('app','Default School Weekdays').'</span>', array('courses/weekdays'),array('class'=>'name-txt')) ?></li>
                    <?php
					}
					if(ModuleAccess::model()->check('Settings'))
					{
        ...
        <div class="block_box">
            ...
            <div class="setbx_bot">
                <ul>                    
                    ...
                    <?php echo CHtml::link(Yii::t('app','Leave Types').'<span>'.Yii::t('app','Teacher Leave Types').'</span>', array('employees/employeeLeaveTypes'),array('class'=>'name-txt')) ?></li>
            ...
            <div class="setbx" style="width:700px;">
                ...
                <div class="setbx_bot">
                    <ul>                       
                        ...
                        <?php echo CHtml::link(Yii::t('app','Manage Fees').'<span>'.Yii::t('app','Create Fees').'</span>', array('fees/create'),array('class'=>'name-txt')) ?></li>
                    </ul>
                </div>
                <div class="clear"></div>
                </div>
            ...
            <div class="setbx" style="width:700px;">
                ...
                <div class="setbx_bot">
                    <ul>                       
                        ...
                        <?php echo CHtml::link(Yii::t('app','File Category').'<span>'.Yii::t('app','Create File Categories').'</span>', array('/downloads/fileCategory/create'),array('class'=>'name-txt')) ?></li>
                        
                        <li class="menu_box">
                        <div class="set_icon"><i class="fa fa-upload"></i></div>
                        <?php echo CHtml::link(Yii::t('app','All File Uploads').'<span>'.Yii::t('app','View All File Uploads').'</span>', array('/downloads'),array('class'=>'name-txt')) ?></li>
                    </ul>
                </div>
                <div class="clear"></div>
                </div>
            ...
            <div class="setbx" style="width:700px;">
                ...
                <div class="setbx_bot">
                    <ul>
                        ...
                        <?php echo CHtml::link(Yii::t('app','SMS Counter').'<span>'.Yii::t('app','Track SMS Count').'</span>', array('smsCount/index'),array('class'=>'name-txt')) ?></li>
                    </ul>
                </div>
                <div class="clear"></div>
                </div>
                ...
                <div class="setbx" style="width:700px;">
                    ...
                    <div class="setbx_bot">
                        <ul>
                            ...
                            <?php echo CHtml::link(Yii::t('app','SMS Templates').'<span>'.Yii::t('app','Edit SMS Templates').'</span>', array('sms/templates'),array('class'=>'name-txt')) ?></li>
                            <li class="menu_box">
                            <div class="set_icon"><i class="fa fa-envelope"></i></div>
                            <?php echo CHtml::link(Yii::t('app','Email Templates').'<span>'.Yii::t('app','Edit Email Templates').'</span>', array('emailtemplates/index'),array('class'=>'name-txt')) ?></li>
                        </ul>
                    </div>
                    <div class="clear"></div>
                    </div>
            ...
            <div class="setbx" style="width:700px;">
                ...
                <div class="setbx_bot">
                    <ul>
                        <li class="menu_box">
                        <div class="set_icon"><i class="fa fa-gear"></i></div>
                        <?php echo CHtml::link(Yii::t('app','Notification Settings').'<span>'.Yii::t('app','Enable SMS, MAIL notifications').'</span>', array('notificationSettings/create'),array('class'=>'name-txt')) ?></li>				
                    </ul>
                </div>
                <div class="clear"></div>
                </div>

...
foreach($roles as $role)
	...
	<div id="othleft-sidebar">
        ...
        'items'=>array(
			...
			array('label'=>Yii::t('app', 'Sent Emails').'<span>'.Yii::t('app', 'Sent Emails').'</span>', 'url'=>array('/notifications/default/sentmail'),'linkOptions'=>array('class'=>'send_mail'),'active'=> (Yii::app()->controller->action->id=='sentmail')),
			array('label'=>Yii::t('app', 'Templates').'<span>'.Yii::t('app', 'All Email templates').'</span>', 'url'=>array('/emailtemplates'),'active'=> (Yii::app()->controller->action->id=='index' or Yii::app()->controller->action->id=='update' or Yii::app()->controller->action->id=='view'),'linkOptions'=>array('class'=>'evntlist_ico')),

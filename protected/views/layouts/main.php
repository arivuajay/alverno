...
<div class="wrapper">
   ...
   <div class="header">
    <div class="lo_drop" style="background-color:<?php echo $topbar_account; ?>" id="account_drop">
       ...
       <ul>
        <li><?php echo CHtml::link(Yii::t('app', 'My Account'), array('/activityFeed'),array('style'=>"color:$topbar_account_text"));?></li>
        ...
        <li>
           <div class="searchbx" >
            <form  action="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=site/search" name="search" method="post">
               <ul>
                <li>
                   <input style="background-color: <?php echo $search_background; ?>; color:<?php echo $seach_text_color; ?>;" class="searchbar" name="char" type="text">
                 </li>
                <li style="position:relative">
                   <input style="background-color: <?php echo $search_background; ?>" class="search_area" src="<?php echo Yii::app()->request->baseUrl; ?>/images/search.png" type="image" name="555" value="<?php echo Yii::t('app','submit');?>">
                 </li>
              </ul>
             </form>
          </div>
  ...
  <?php
	  if(ModuleAccess::model()->modulecount()>10)
	  {
		  $height = 161;
	  }
	  else
        ...
        <ul id="sortable1" class="connectedSortable">
		   ...
		   <li>
            <?php
				...
				if(isset(Yii::app()->controller->module->id) and Yii::app()->controller->module->id=='dashboard' and Yii::app()->controller->action->id!='events')
				{
           ...
           <li>
			...
			{
				if(Yii::app()->controller->id=='students' || Yii::app()->controller->id =='guardians'|| Yii::app()->controller->id =='studentCategories' || Yii::app()->controller->id =='studentCategory' || (Yii::app()->controller->id =='logCategory' and Yii::app()->controller->module->id=='students') ||  Yii::app()->controller->id=='waitinglistStudents' ||  Yii::app()->controller->id=='studentLeaveTypes'|| Yii::app()->controller->action->id=='approval' || Yii::app()->controller->action->id=='onlineapplicants' || (Yii::app()->controller->id=='admin' && Yii::app()->controller->action->id=='view') || Yii::app()->controller->action->id=='profileedit')
				{
				    echo CHtml::link('<i class="fa fa-user"></i></br>'.Yii::t('app','Students'), array('/students'),array('class'=>' active','style'=>"border-color:$menu_border; color:$menu_active_color"));
				}
				else
				{
					echo CHtml::link('<i class="fa fa-user"></i></br>'.Yii::t('app','Students'), array('/students'),array('class'=>'','style'=>"border-color:$menu_border; color:$menu_color"));
				}
			}
				?>
          </li>
			...
			if(ModuleAccess::model()->check('Settings'))
			{
				if((isset(Yii::app()->controller->module->id) and Yii::app()->controller->module->id=='backup') or Yii::app()->controller->id=='configurations' or Yii::app()->controller->id=='subjects' or Yii::app()->controller->id=='subjectName' or Yii::app()->controller->id=='user'
					...
					or Yii::app()->controller->id=='assignment' or Yii::app()->controller->id=='authItem'
                                        ...
                                        or (Yii::app()->controller->id=='admin' and in_array(Yii::app()->controller->action->id,array('admin','create','update')))
                                        or Yii::app()->controller->module->id=='translate' or Yii::app()->controller->module->id=='holidays'
                                        or Yii::app()->controller->id=='themes' or Yii::app()->controller->id=='portalThemes' or Yii::app()->controller->id=='offlineSettings' or Yii::app()->controller->id=='formFields'
           ...
           <li>
            <?php
			if(ModuleAccess::model()->check('Transport'))
			{
          ...
          <li>
            <?php
				...
				{
				 if((isset(Yii::app()->controller->module->id) and in_array(Yii::app()->controller->module->id,array('notifications','sms'))) or (in_array(Yii::app()->controller->id,array('emailtemplates'))))
				 {

				 	echo CHtml::link('<i class="fa fa-comments"></i><br>'.Yii::t('app','Notify'), array('/notifications/default/sendmails'),array('class'=>' active','style'=>"border-color:$menu_border; color:$menu_active_color"));

				 }else{

					 echo CHtml::link('<i class="fa fa-comments"></i><br>'.Yii::t('app','Notify'), array('/notifications/default/sendmails'),array('class'=>'','style'=>"border-color:$menu_border; color:$menu_color"));

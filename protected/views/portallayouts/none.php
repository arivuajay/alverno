...
<script src="<?php echo Yii::app()->request->baseUrl;?>/res_js/jquery-1.7.2.min.js"></script>
  <title><?php $college=Configurations::model()->findByPk(1); 
...
<?php 
 ...
 ?>	
  ...
  <link href="res_css/mailbox_style.css" rel="stylesheet">
  ...
  <div class="mainpanel">
    ...
    <div class="headerbar" style="color: <?php echo $header_text_color; ?>; background-color: <?php echo $header_bar_background; ?>; border-left-color:<?php echo $header_border; ?> ">
      ...
      <a class="menutoggle" style="border-right-color: <?php echo $header_border; ?>"><i class="fa fa-bars"></i></a>
				...
				?>
      <div class="searchform"><span class="col-md-4"><?php echo Yii::t('app','Welcome'); ?> <strong><?php echo $guard->parentFullName('forParentPortal');?></strong> <?php echo Yii::t('app','in to your profile.'); ?></span></div>
      ...
      <div class="header-right">
        ...
        <!--<li>
            <div class="btn-group">
              ...
              <?php //echo CHtml::link(Yii::t('parentportal','<i class="glyphicon glyphicon-download"></i><span class="badge">1</span>'),array('/portalmailbox'),array('class'=>'btn btn-default dropdown-toggle tp-icon')); ?>
          ...
          <li>
            ...
            <?php /*?>  <?php echo CHtml::link(Yii::t('parentportal','<i class="glyphicon glyphicon-envelope"></i>'),array('/portalmailbox'),array('class'=>'btn btn-default dropdown-toggle tp-icon')); ?><?php */?>
            ...
            <div class="btn-group">
              ...
              <button style="background-color: <?php echo $header_bar_background; ?> !important" type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                 <?php
						...
						?>
                <?php echo $guard->parentFullName('forParentPortal');?>
                <span class="caret"></span>
              </button>
              <ul class="dropdown-menu dropdown-menu-usermenu pull-right" style="background-color: <?php echo $header_dropdown_background; ?>; ">
                <li><?php echo CHtml::link('<i class="glyphicon glyphicon-user"></i> '.Yii::t('app','My Profile'),array('/parentportal/default/profile'),array('class'=>'profile')); ?></li>

...
<div class="edit_bttns" style="top:20px; right:20px;">
    <ul>
    	<li> <?php echo CHtml::link('<span>'.Yii::t('app','Create News').'</span>', array('create'),array('class'=>'addbttn last ')); ?></li>
        <li> <?php echo CHtml::link('<span>'.Yii::t('app','View News').'</span>', array('/mailbox/news'),array('class'=>'addbttn last ')); ?></li>
    </ul>
</div>
<center>
    <?php
	...
	<div class="knewslist_con">
        ...
        <div class="knews_controls">
        	<ul>
				...
				?></li>
                <li><?php echo CHtml::Link(Yii::t('app','Delete'),array('news/delete','id'=>$news1->id),array('class'=>'delete','confirm' => Yii::t('app','Are you sure?'))); ?></li>
            </ul>
            <?php 
			if($news1->is_published == 0)
			{
				echo CHtml::Link(Yii::t('app','Publish'),array('news/publish','id'=>$news1->id),array('class'=>'publish')); 
			}
			else
			{
			?>

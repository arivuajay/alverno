    ...
    return $message;
			...
			'items'=>array(
					...
					array('label'=>''.Yii::t('app','General Settings').'<span>'.Yii::t('app','Manage Configurations').'</span>',  'url'=>array('/configurations/index'),'linkOptions'=>array('class'=>'gs_ico' ), 'itemOptions'=>array('id'=>'menu_1') 
						  ...
						  array('label'=>Yii::t('app','Create New User').'<span>'.Yii::t('app','Add New User Details').'</span>', 'url'=>array('/user/admin/create'),'active'=> ((Yii::app()->controller->id=='admin' and Yii::app()->controller->action->id=='create') ? true : false),'linkOptions'=>array('class'=>'sl_ico' )),
						  array('label'=>Yii::t('app','Manage Users').'<span>'.Yii::t('app','Manage All Users').'</span>', 'url'=>array('/user/admin'),'active'=> ((Yii::app()->controller->id=='admin' and Yii::app()->controller->action->id!='create') ? true : false),'linkOptions'=>array('class'=>'sm_ico' )),
						  array('label'=>Yii::t('app','Change Password').'<span>'.Yii::t('app','Manage All Users').'</span>', 'url'=>array('/user/profile/changepassword'),'linkOptions'=>array('class'=>'sm_ico' )),
						   /*array('label'=>Yii::t('app','Create Profile Field<span>Add New Profile</span>'), 'url'=>array('/user/profileField/create'),'linkOptions'=>array('class'=>'sl_ico' )),
						  array('label'=>Yii::t('app','Manage Profile Field<span>Manage Profiles</span>'), 'url'=>array('/user/profileField/admin'),'linkOptions'=>array('class'=>'sm_ico' )),*/
					      ...
					      // ),
					array('label'=>'<h1>'.Yii::t('app','Courses and').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").'</h1>'),
					       
						array('label'=>Yii::t('app','List Courses and').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").'<span>'.Yii::t('app','All Courses and').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").' '.Yii::t('app','Details').'</span>', 'url'=>array('/courses/courses/managecourse'),'linkOptions'=>array('class'=>'lbook_ico' )),

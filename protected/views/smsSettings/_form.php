...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <table width="200px">
    	...
    	<tr>
            ...
            <td><?php echo Yii::t('app','Student Admission'); ?></td>
        </tr>
        <tr>
        	<td class="check">
            ...
            <td><?php echo Yii::t('app','Student Attendance'); ?></td>
        </tr>
        <tr>
        	<td class="check">
            ...
            <td><?php echo Yii::t('app','Teacher Appointment'); ?></td>
        </tr>
        <tr>
        	<td class="check">
            ...
            <td><?php echo Yii::t('app','Exam Schedule'); ?></td>
        </tr>
        <tr>
        	<td class="check">
            ...
            <td><?php echo Yii::t('app','Exam Result'); ?></td>
        </tr>
        <tr>
        	<td class="check">
        ...
        <tr>
            ...
            <td><?php echo Yii::t('app','Library'); ?></td>
        </tr>
    </table>
    </div>
	<?php /*?><div class="row">

 ...
 * @ver 1.3
 ...
 .png_bg{margin: 0 6px 0 50px !important;}
...
<div id="student-document-list_form_con" class="client-val-form">
    ...
    <?php   endif;  ?>
    <?php      $val_error_msg = 'Error.Student Document Type was not saved.';
...
<?php   $formId='student-document-list-form';
   ...
   ($model->isNewRecord)?CController::createUrl('studentDocumentList/ajax_create')
    ...
    <div class="row for_radio" style="display: inline-block; margin: 0 0 -6px;">
        ...
        <?php
         $mandatorylist = array('0'=>'No', '1'=>'Yes,cannot be skipped during Registration','2'=>'Yes,can be skipped during Registration');

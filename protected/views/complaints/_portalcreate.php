<div class="pageheader">
  <div class="col-lg-8">
    <h2><i class="fa fa-user"></i><?php echo Yii::t("app",'Complaints');?></h2>
  </div>
  <div class="col-lg-2">
      </div>
...
<div class="people-item">
	...
	<div class="form-group">
		...
		<?php echo $form->textArea($model,'complaint',array('rows'=>3, 'cols'=>15,'class'=>'form-control')); ?>
	...
	<div class="buttons">
        ...
        <input type="reset" value="Reset" class="membergray_but btn btn-success">
	</div>

...
<div class="edit_bttns " style="top:20px; right:20px;">
    <ul>
        <li><?php echo CHtml::link('<span>'.Yii::t('app','Create Complaint Category').'</span>', array('#'),array('id'=>'add_complaint-categories')); ?></li>
    </ul>
</div>
<?php  
...
$del_con = Yii::t('app', 'Are you sure you want to delete this Complaint category?');

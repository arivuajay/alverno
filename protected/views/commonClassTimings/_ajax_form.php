...
<div id="class-timings_form_con" class="client-val-form">
    <?php if ($model->isNewRecord) : ?>    <h3 id="create_header"><?php echo Yii::t('app','Set New Common Class Timing');?></h3>
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header"><?php echo Yii::t('app','Update Common Class Timing');?></h3>
    <?php   endif;  ?>
    <?php      $val_error_msg = Yii::t('app','Error ! The class timing was not saved.');
    $val_success_message = ($model->isNewRecord) ?
            Yii::t('app','Common Class Timing was set successfully.') :
            Yii::t('app','Common Class Timing was updated successfully.');
  ?>
...
<?php   $formId='class-timings-form';
   $actionUrl =
   ($model->isNewRecord)?CController::createUrl('commonClassTimings/ajax_create')
                                                                 :CController::createUrl('commonClassTimings/ajax_update');
    ...
    <div class="row">
        ...
        <div class="row">
            <?php echo $form->labelEx($model,'start_time',array('style'=>'color:#4F4E4E')); ?>
            <?php 
    ...
    ?> 
        ...
        <div class="row">
            <?php echo $form->labelEx($model,'end_time',array('style'=>'color:#4F4E4E')); ?>
           <?php
		   if($time=='h:i A')
		   {
			    $this->widget('application.extensions.jui_timepicker.JTimePicker', array(
  ...
  <tr>
    ...
    <td><?php echo $form->labelEx($model,'is_break'); ?></td>
  ...
  <?php
      ...
      <tr>
        <td> <?php echo $form->checkBox($model,'all_batches'); ?></td>
        <td><?php echo $form->labelEx($model,'all_batches'); ?></td>
        <td> <?php echo $form->error($model,'all_batches'); ?></td>
      </tr>
  <?php } ?>    
</table>

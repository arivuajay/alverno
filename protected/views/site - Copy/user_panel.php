<div class="" id="" >
			...
			else
			{
				$path=Yii::app()->request->getUrl();
				 ...
				 <h2 class="title"><?php echo Yii::t('app','Teachers');?></h2>
                      <h2 class="caption"><?php echo count(Employees::model()->findAll("is_deleted 	=:x", array(':x'=>0))); ?> <?php echo Yii::t('app','Records')?></h2>
...
echo CHtml::link(Yii::t('app',"All"), array('/site/emanage', 'ename' => $name,'employeenumber'=>$ad,'Employees[employee_department_id]'=>$bat,'widget' => $widget, 'val' => ''));
 ?>                            
</li>

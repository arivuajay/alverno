...
?>
				 ...
				 <h2 class="title"><?php echo Yii::t('app','Students') ?></h2>
                      <h2 class="caption"><?php echo count(Students::model()->findAll("is_deleted 	=:x", array(':x'=>0)));?> <?php echo Yii::t('app','Records')?></h2>
                     ...
                     <div id="dd" style=" display:none; background:#fff; left:100px; top:30px" class="drop">
                        ...
                        'method'=>'GET',
                            ...
                            <table width="55%" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                                    <td width="18%">
                        <?php echo Yii::t('app','Name')?>&nbsp;</td><td><input type="text" placeholder="search" name="name"  value="<?php echo isset($_GET['name']) ? CHtml::encode($_GET['name']) : '' ; ?>" />
 ...
 <table width="68%" border="0" cellspacing="0" cellpadding="0">
                             <tr>
                                    <td width="34%">                  
<?php echo Yii::t('app','Admission No')?>&nbsp;</td><td><input type="text" placeholder="search" name="admissionnumber" value="<?php echo isset($_GET['admissionnumber']) ? CHtml::encode($_GET['admissionnumber']) : '' ; ?>" /></td><td>
<?php  echo CHtml::ajaxButton(Yii::t('app',"Apply"),CController::createUrl('/site/manage'), array(
																									'data' => 'js:$("#search-form").serialize()',
																									'update' => '#student_panel_handler',
																									'type'=>'GET',
...
echo '</td>';
echo '<td>'.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").'</td><td>';
...
echo CHtml::link(Yii::t('app',"All"), array('/site/manage', 'name' => $name,'admissionnumber'=>$ad,'Students[batch_id]'=>$bat,'widget' => $widget, 'val' => ''));
 ?>                            
</li>
...
<?php  echo CHtml::link("Z", array('/site/manage', 'name' => $name,'admissionnumber'=>$ad,'Students[batch_id]'=>$bat,'widget' => $widget, 'val' => 'Z')); ?>  
                ...
                <div class="tablebx">  
                	...
                	<table width="100%" border="0" cellspacing="0" cellpadding="0" id="example">
                          ...
                          <tr>
                          <?php 
						  if(isset($_REQUEST['widget']) and $_REQUEST['widget']=='1')
                          { 
						  ?>
                           ...
                           <td><?php echo CHtml::link(ucfirst($list_1->first_name).'  '.ucfirst($list_1->middle_name).'  '.ucfirst($list_1->last_name),array('attendance/subjectAttendance/individual','id'=>$list_1->id)) ?></td>

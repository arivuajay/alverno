                ...
                'Employees' => array(
                    ...
                    'external' => array(
                        'bank_detail_id' => array(
                            ...
                            'label' => 'Bank Details',
                            'description' => 'PAN Number, PF Number and Account Number are unique',
                            'allowedColumns' => array(
                                'pan_no',
                                'bank_account',
                                'pf_no',
...
//											'ipFilters'=>array('127.0.0.1','::1','192.168.9.13','192.168.9.17'),
    ...
    'components' => array(
        'Paypal' => array(
            ...
            'apiPassword' => '',
            'apiSignature' => '',
            'apiLive' => true, // True for Live Transaction
        ...
        'Ib' => array(
            'class' => 'application.components.Ib',
            'returnURL' => '/fees/ib/confirm'
        ),
        'request' => array(
